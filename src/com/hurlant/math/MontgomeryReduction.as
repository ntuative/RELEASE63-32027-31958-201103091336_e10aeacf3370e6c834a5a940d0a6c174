package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1866 = param1.invDigit();
         this.var_1867 = this.var_1866 & 32767;
         this.var_2641 = this.var_1866 >> 15;
         this.var_2643 = 131071;
         this.var_2642 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_166) > 0)
         {

package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1542:int = 10000;
      ...
      private var var_454:ByteArray;
      
      private var var_1015:IEncryption;
      
      private var var_660:IProtocol;
      
      private var _id:String;
      
      private var var_1016:IMessageClassManager;
      
      private var var_293:ICoreCommunicationManager;
      
      private var var_455:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_293 = param2;
         this.var_454 = new ByteArray();
         this.var_1016 = new MessageClassManager();
         this.var_79 = new Socket();
         this.var_326 = new Timer(const_1542,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_455)
         {
            this.var_455.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_326.start();
         this.var_661 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1016.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_660.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_455)
         {
            this.var_455.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1015 != null)
         {
            _loc3_ = this.var_1015.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1016.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_660.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_660.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1015 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_660.getMessages(this.var_454,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_455)
               {
                  this.var_455.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1016.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_454,offset);
               this.var_454 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_454.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_454.writeByte(this.var_79.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_326.stop();
         this.var_1536 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_661));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1536 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_661));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_661));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_661));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_661));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_661));

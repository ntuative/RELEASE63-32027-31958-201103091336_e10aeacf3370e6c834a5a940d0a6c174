package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1450:uint = 0;
      
      public static const const_731:uint = 1;
      
      public static const const_1013:uint = 2;
      
      public static const const_827:uint = 4;
      
      public static const const_1586:uint = 8;
      
      public static const const_1392:uint = 16;
      
      public static const const_1763:uint = 64;
      
      public static const const_1782:uint = 128;
      
      public static const const_1004:uint = 256;
      
      protected static var var_540:uint = 0;
      
      protected static var var_323:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_206.numChildren > 0)
               {
                  this.var_206.removeChildAt(0);
               }
            }
            this.var_206 = null;
            while(numChildren > 0)
         ...
         if(this.var_809)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_323 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2003,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2003,16777215);
                  }
                  var_323 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_809)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_323 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_206 == null)
         {
            this.var_206 = new Sprite();
            this.var_206.name = this.name + " - Child Container";
            this.var_206.mouseEnabled = false;
      ...
      {
         return this.var_206 != null ? int(this.var_206.numChildren) : 0;
      }

package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_978:uint = 8;
      
      private static const const_1374:String = "skin";
      
      private static const const_1375:String = "bitmap";
      
      private static const const_1373:String = "fill";
      
      private static const const_1378:String = "text";
      
      private static const const_1376:String = "label";
      
      private static const const_1377:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "HabboNavigatorTrackingEvent";
      ...
      private var var_1936:Dictionary;
      
      private var var_2713:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_987 = new Dictionary();
         this.var_986 = new Dictionary();
         this.var_1936 = new Dictionary();
         this.var_2713 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1936,this.var_2713);
         this.var_2711 = new Dictionary();
         this.var_2712 = new Dictionary();
         StateCodeTable.fillTables(this.var_2711,this.var_2712);
         this.var_442 = new Dictionary();
         this.var_442[const_1374] = BitmapSkinRenderer;
         this.var_442[const_1375] = BitmapDataRenderer;
         this.var_442[const_1373] = FillSkinRenderer;
         this.var_442[const_1378] = TextSkinRenderer;
         this.var_442[const_1376] = LabelRenderer;
         this.var_442[const_1377] = ShapeSkinRenderer;
         this.var_442[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_442[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_325 == null)
         {
            var_325 = new Array();
            var_325.push(WindowState.const_69);
            var_325.push(WindowState.const_83);
            var_325.push(WindowState.const_99);
            var_325.push(WindowState.const_53);
            var_325.push(WindowState.const_96);
            var_325.push(WindowState.const_85);
            var_325.push(WindowState.const_108);
            var_325.push(WindowState.const_94);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1936[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_987[param1] = new Array(const_978);
         }
         this.var_987[param1][param2] = param3;
         if(this.var_986[param1] == null)
         {
            this.var_986[param1] = new Array(const_978);
         }
         this.var_986[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_987[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_197)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_986[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_197)

package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_945:uint = 1;
      
      private static const const_946:uint = 2;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1396 = 4294967295;
         this.var_910 = 0;
         this.var_1761 = new ColorTransform();
         this.var_998 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_946) : uint(const_601);
         var _loc6_:Boolean = this.var_176.width > 0 && this.var_176.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_910))
            {
               _loc5_ = const_945;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_945)
               {
                  ...
                  if(this.var_597)
                  {
                     ...
                     _loc7_.draw(param1,this.var_100,this.var_100.rect,this.var_910,false);
                  ...
                  {
                     this.var_998.tx = param2.x;
                     this.var_998.ty = param2.y;
                     this.var_1761.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_100,this.var_998,this.var_1761,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_197)
            {
               _loc2_ = this.var_860.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_197);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_860.getTheActualState(param1.type,param1.style,param1.state) != this.var_1396;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            case WindowRedrawFlag.const_64:
               this.var_597 = true;
               _loc4_ = true;
               break;
            ...
            case WindowRedrawFlag.const_458:
               ...
               break;
            case WindowRedrawFlag.const_1115:
               this.var_910 = this.var_860.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_910 != this.var_1396)
               {
                  this.var_597 = true;
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1233:
               ...
               break;
            case WindowRedrawFlag.const_1194:
               _loc4_ = true;
         }
         if(_loc4_)
         {

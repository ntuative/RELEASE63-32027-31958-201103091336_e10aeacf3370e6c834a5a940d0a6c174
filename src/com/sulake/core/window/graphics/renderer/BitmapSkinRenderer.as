package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_804:Dictionary;
      
      private var var_828:Matrix;
      
      public function BitmapSkinRenderer(param1:String)
      {
         super(param1);
         this.var_805 = new Dictionary(false);
         this.var_804 = new Dictionary(false);
         this.var_828 = new Matrix();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_805 = null;
            for(_loc1_ in this.var_804)
            {
               _loc2_ = this.var_804[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_804[_loc1_];
            }
            this.var_804 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_450[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_297)
                  {
                     var_33.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_482)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_280)
                  {
                     _loc12_ = true;
                     var_33.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_297)
                  {
                     var_33.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_482)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_280)
                  {
                     _loc13_ = true;
                     var_33.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_280 || _loc10_.scaleH == SkinLayoutEntity.const_280)
                  {
                  ...
                  {
                     this.var_828.a = 0 / _loc17_.width;
                     this.var_828.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_33.width,var_33.height,false);
                     _loc30_.draw(_loc17_,this.var_828);
                     _loc31_ = new BitmapData(var_33.width,var_33.height,true,0);
                     _loc31_.draw(_loc18_,this.var_828,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_297)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_297)
               {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_804[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)

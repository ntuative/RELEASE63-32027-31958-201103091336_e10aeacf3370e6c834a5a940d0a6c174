package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_190:ISelectableWindow;
      
      protected var var_1999:Boolean = true;
      ...
      {
         if(param2.type == WindowNotifyEvent.const_214)
         {
      ...
      {
         return this.var_190 as ISelectableWindow;
      }
         ...
         if(param1 != null)
         {
            if(param1 != this.var_190)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_349,this,this.var_190));
               }
            }
         }
      }

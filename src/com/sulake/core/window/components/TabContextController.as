package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1358:String = "_SELECTOR";
      
      private static const const_1357:String = "_CONTENT";
       
      
      protected var var_1007:ITabSelectorWindow;
      
      protected var var_2025:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1007 = findChildByTag(const_1358) as ITabSelectorWindow;
            if(this.var_1007 != null)
            {
               this.var_1007.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2025 = findChildByTag(const_1357) as IWindowContainer;
         }
      ...
      {
         return !!this.var_720 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1007.numSelectables;
      }
      ...
      public function method_6(param1:ITabButtonWindow) : uint
      {

package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_652:Number;
      
      protected var var_653:Number;
      ...
      protected var var_2008:Boolean = false;
      
      protected var var_534:Boolean = false;
      
      protected var _spacing:int = 0;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_2832:Number = 0.0;
      
      protected var var_2833:Number = 0.0;
      
      protected var var_1002:Boolean = true;
      
      protected var var_447:Boolean = false;
      
      protected var var_1251:Boolean = false;
      
      protected var var_2010:int = 0;
      
      protected var var_2009:int = 0;
      
      protected var var_1248:Number;
      
      protected var var_1250:Number;
      
      protected var var_1249:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_106 = 0;
         this.var_94 = 0;
         this._horizontal = param2 == WindowType.const_394;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_167 = var_446 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_401,WindowStyle.const_644,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_49,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_539,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_321,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_451,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1251;
      }
      ...
      {
         return new Rectangle(this.var_652 * this.maxScrollH,this.var_653 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_652)
         {
            this.var_652 = param1;
            this._container.x = -this.var_652 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_64);
            dispatchEvent(new WindowEvent(WindowEvent.const_435,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_653 = param1;
            this._container.y = -this.var_653 * this.maxScrollV;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_64);
            dispatchEvent(new WindowEvent(WindowEvent.const_435,this,null));
         }
      }
      ...
      {
         this.var_2832 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2833 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_428,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_539,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_321,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_45:
               this.var_2010 = _loc3_;
               this.var_2009 = _loc4_;
               this.var_1248 = 0;
               this.var_1250 = 0;
               this.var_1249 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_185:
               if(this.var_1249)
               {
                  this.var_1248 = this.var_2010 - _loc3_;
                  this.var_1250 = this.var_2009 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1248 != 0 && this.var_106 != 0)
                     {
                        this.scrollH += this.var_1248 / this.var_106;
                     }
                  }
                  else if(this.var_1250 != 0 && this.var_94 != 0)
                  {
                     this.scrollV += this.var_1250 / this.var_94;
                  }
                  this.var_2010 = _loc3_;
                  this.var_2009 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_200:
               if(this.var_1249)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1248,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1250);
                  }
                  this.var_1249 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1002 && !this.var_534 && this._container)
         {
            this.var_534 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_624)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_359,this._spacing,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1219);
         }
         if(this.var_1002 != PropertyDefaults.const_1158)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_734,this.var_1002,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1521);
         }
         if(this.var_447 != PropertyDefaults.const_1143)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_671,this.var_447,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1467);
         }
         if(this.var_1251 != PropertyDefaults.const_1001)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_839,this.var_1251,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1482);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_734:
                  this.var_1002 = _loc2_.value as Boolean;
                  break;
            }
         }

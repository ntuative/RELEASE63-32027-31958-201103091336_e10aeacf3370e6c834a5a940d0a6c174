package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_950:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_951:String = "default";
      
      private var var_1165:String = null;
      
      private var var_1845:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1165 == param2)
         {
            return;
         }
         param1.var_1165 = param2;
         param1.var_1845 = null;
         if(param1.var_1165 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1165);
            param1.var_1845 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_689.indexOf(param1) > -1)
         {
            this.var_951 = param1;
         }
      }
      ...
      {
         return this.var_951 == LinkTarget.const_31 ? defaultLinkTarget : this.var_951;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1845;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_710)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_951 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_703,this.var_951,PropertyStruct.const_52,true,PropertyDefaults.const_689));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_703)
            {
               this.var_951 = _loc2_.value as String;
               break;
            }

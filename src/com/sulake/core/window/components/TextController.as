package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1235:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_811:Number;
      ...
      protected var var_1005:Boolean = false;
      
      private var var_405:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_405,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_405 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_405,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_199);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_854 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_405);
      }
      ...
      {
         this.var_811 = param1;
         this._field.scrollH = this.var_811 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_811 * this.maxScrollH,this.var_535 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_405);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1118) ? new PropertyStruct(PropertyDefaults.const_759,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1154) : PropertyDefaults.const_1473);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1070 ? new PropertyStruct(PropertyDefaults.const_641,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1008) : PropertyDefaults.const_1548);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_38,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_135,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_261,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1068 ? new PropertyStruct(PropertyDefaults.const_1199,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1144) : PropertyDefaults.const_1579);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_762) ? new PropertyStruct(PropertyDefaults.const_379,this._field.textColor,PropertyStruct.const_135,true) : PropertyDefaults.const_1210);
         _loc1_.push(this.var_405 != TextStyleManager.const_199 ? new PropertyStruct(PropertyDefaults.const_357,this.var_405,PropertyStruct.const_52,true,PropertyDefaults.const_725) : PropertyDefaults.const_1147);
         _loc1_.push(this.var_41.left != PropertyDefaults.const_723 ? new PropertyStruct(PropertyDefaults.const_267,this.var_41.left,PropertyStruct.const_40,true) : PropertyDefaults.const_437);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_673 ? new PropertyStruct(PropertyDefaults.const_249,this.var_41.top,PropertyStruct.const_40,true) : PropertyDefaults.const_468);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_648 ? new PropertyStruct(PropertyDefaults.const_248,this.var_41.right,PropertyStruct.const_40,true) : PropertyDefaults.const_564);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_865 ? new PropertyStruct(PropertyDefaults.const_247,this.var_41.bottom,PropertyStruct.const_40,true) : PropertyDefaults.const_541);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1120 ? new PropertyStruct(PropertyDefaults.const_701,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1566);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_244,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_244,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_244,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}

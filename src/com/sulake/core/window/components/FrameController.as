package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1236:String = "_TITLE";
      
      private static const const_1239:String = "_HEADER";
      ...
      private var var_1267:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1236) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1267 = findChildByTag(const_1239) as IHeaderWindow;
            if(!this.var_1267)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_170 = findChildByTag(const_1238) as IWindowContainer;
            if(!this.var_170)
            {
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1234,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1004 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_258);
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_267,_loc3_.left,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_249,_loc3_.top,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_248,0 - _loc3_.right,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_247,0 - _loc3_.bottom,PropertyStruct.const_40,_loc2_));
         }
         else
         {

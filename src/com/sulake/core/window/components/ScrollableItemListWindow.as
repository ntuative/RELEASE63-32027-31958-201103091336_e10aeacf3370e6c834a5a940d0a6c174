package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1135:IItemListWindow;
      
      private var var_417:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_83))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_417)
         {
            this.var_417.removeEventListener(WindowEvent.const_324,this.scrollBarEventProc);
            this.var_417.removeEventListener(WindowEvent.const_229,this.scrollBarEventProc);
            this.var_417 = null;
         }
         if(this.var_1135)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1135)
         {
            this.var_1135 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_417)
         {
            this.var_417 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_417)
            {
               this.var_417.addEventListener(WindowEvent.const_324,this.scrollBarEventProc);
               this.var_417.addEventListener(WindowEvent.const_229,this.scrollBarEventProc);
            }
         }
         return this.var_417;
      }
      ...
      {
         if(param1.type == WindowEvent.const_324)
         {
            this.showScrollBar();
         }
         else if(param1.type == WindowEvent.const_229)
         {
            this.hideScrollBar();
         }
      }

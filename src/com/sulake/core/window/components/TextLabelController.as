package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_405);
         if(_loc1_)
         {
      ...
      {
         if(this.var_405 != param1.name)
         {
            this.var_405 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2478 = _loc2_.textWidth;
         this.var_2477 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_347 != _loc2_.color : this.var_347 != null && this.var_347 != PropertyDefaults.const_762) ? new PropertyStruct(PropertyDefaults.const_379,this.var_347,PropertyStruct.const_135,true) : PropertyDefaults.const_1210);
         if(this.var_41)
         {
            if(this.var_41.left != PropertyDefaults.const_723)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_267,this.var_41.left,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_437);
            }
            if(this.var_41.top != PropertyDefaults.const_673)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_249,this.var_41.top,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_468);
            }
            if(this.var_41.right != PropertyDefaults.const_648)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_248,this.var_41.right,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_564);
            }
            if(this.var_41.bottom != PropertyDefaults.const_865)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_247,this.var_41.bottom,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_541);
            }
         }
         else
         {

package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1511:uint = 500;
      
      protected var var_1257:String = "";
      
      protected var var_1245:Boolean = false;
      
      protected var var_720:Boolean = false;
      ...
      {
         this.var_1257 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1013,var_11);
         }
         return var_22;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_516)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_720 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_353,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_618,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1604);
         _loc1_.push(this.var_1245 != PropertyDefaults.const_1138 ? new PropertyStruct(PropertyDefaults.const_646,this.var_1245,PropertyStruct.const_38,true) : PropertyDefaults.const_1615);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1189 ? new PropertyStruct(PropertyDefaults.const_778,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1439);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1208 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1676);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_646:
                  this.var_1245 = _loc2_.value as Boolean;
                  if(this.var_1245)
                  {
               ...
               case PropertyDefaults.const_778:
                  ...
                  break;
               case PropertyDefaults.const_618:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1123:

package com.sulake.core.window.services
{
   ...
   public class FocusManager extends ChildEntityArrayReader implements IFocusManagerService
   {
      ...
      public function FocusManager(param1:DisplayObject)
      {
         ...
         this.var_220.addEventListener(Event.ACTIVATE,this.onActivateEvent);
         this.var_220.addEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
         this.var_220.addEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
         this.var_220.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
         super();
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this.var_220.removeEventListener(Event.ACTIVATE,this.onActivateEvent);
            this.var_220.removeEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
            this.var_220.removeEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
            this.var_220.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
            this.var_220 = null;
            this._disposed = true;
            var_32 = null;
         }

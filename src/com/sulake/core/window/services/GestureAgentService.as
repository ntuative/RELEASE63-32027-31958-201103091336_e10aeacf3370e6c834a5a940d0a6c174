package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_203:Timer;
      
      protected var var_1429:uint = 0;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this.var_203 = new Timer(40,0);
            this.var_203.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_203.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         ...
         {
            this.var_275(this.var_1243,this.var_1242);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_203.stop();
            this.var_203.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_203 = null;
         }
         if(this._working)
         {

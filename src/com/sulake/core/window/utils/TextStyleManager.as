package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_199:String = "regular";
      ...
      private static var var_505:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_605:String = "{";
      
      private static const const_606:String = "}";
      
      private static const const_1353:String = "/*";
      
      private static const const_1354:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_88[const_199],var_88[ITALIC],var_88[BOLD]];
            var_88.reset();
            var_88[const_199] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_505.indexOf(_loc4_.name) == -1)
            {
               var_505.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_606);
         if(countSubStrings(param1,const_605) != countSubStrings(param1,const_606))
         {
            throw new Error("Mismatching amount of \"" + const_605 + "\" versus \"" + const_606 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1353) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1354) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_605)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }

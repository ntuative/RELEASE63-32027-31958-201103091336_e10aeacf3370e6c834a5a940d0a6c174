package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2802 = param3 == const_215 || param3 == const_140 || param3 == const_241 || param3 == const_227;
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_38:
               return Boolean(this.var_174) == true ? "true" : "FurnitureEcotronBoxLogic";
            case const_241:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_227:
               ...
               break;
            case const_135:
               _loc1_ = "<var key=\"" + this.var_583 + "\" value=\"" + "0x" + uint(this.var_174).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_583 + "\" value=\"" + this.var_174 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }

package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1857:String = "_INCLUDE";
      
      public static const const_1947:String = "_TEMP";
      
      private static const const_1296:String = "layout";
      
      private static const const_928:String = "window";
      
      private static const const_929:String = "variables";
      
      private static const const_930:String = "filters";
      
      private static const const_596:String = "name";
      
      private static const const_1290:String = "style";
      
      private static const const_595:String = "params";
      
      private static const const_1292:String = "tags";
      
      private static const X:String = "x";
      
      private static const Y:String = "y";
      
      private static const const_1250:String = "width";
      
      private static const const_1248:String = "height";
      
      private static const const_1298:String = "visible";
      
      private static const const_1295:String = "caption";
      ...
      private static const const_1293:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1289:String = "treshold";
      
      private static const const_1291:String = "children";
      
      private static const const_1294:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1287:String = "height_min";
      
      private static const const_1286:String = "height_max";
      
      private static const const_594:String = "true";
      
      private static const const_166:String = "0";
      
      private static const const_1297:String = "$";
      
      private static const const_1249:String = ",";
      
      private static const const_48:String = "";
      
      private static const const_1288:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1285:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1246:Dictionary;
      
      protected var var_1247:Dictionary;
      
      protected var var_1001:Dictionary;
      
      protected var var_1507:Dictionary;
      
      protected var var_2002:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1246 = new Dictionary();
         this.var_1247 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1246,this.var_1247);
         this.var_1001 = new Dictionary();
         this.var_1507 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1001,this.var_1507);
         this.var_2002 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1285,const_48);
         return param1.replace(const_1288,const_48);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1246)
            {
               delete this.var_1246[_loc1_];
            }
            for(_loc1_ in this.var_1247)
            {
               delete this.var_1247[_loc1_];
            }
            for(_loc1_ in this.var_1001)
            {
               delete this.var_1001[_loc1_];
            }
            for(_loc1_ in this.var_1507)
            {
               delete this.var_1507[_loc1_];
            }
            this.var_2002.dispose();
            this.var_2002 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1296)
         {
            _loc8_ = param1.child(const_929);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_930).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1246[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_596,variables,"")));
         style = uint(this.parseAttribute(xml,const_1290,variables,style));
         params = uint(this.parseAttribute(xml,const_595,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1292,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_166));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_166));
         rect.width = Number(this.parseAttribute(xml,const_1250,variables,const_166));
         rect.height = Number(this.parseAttribute(xml,const_1248,variables,const_166));
         visible = this.parseAttribute(xml,const_1298,variables,visible.toString()) == const_594;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_595).length() > 0)
         {
            list = xml.child(const_595).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_596,variables,"") as String;
               if(this.var_1001[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_596)) + "\"!");
               }
               params |= this.var_1001[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_48) : const_48;
         caption = unescape(String(this.parseAttribute(xml,const_1295,variables,caption)));
         if(tag != const_48)
         {
            tags = tag.split(const_1249);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_929)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1294,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1287,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1286,variables,window.limits.maxHeight));
         ...
         clipping = this.parseAttribute(xml,const_1293,variables,window.clipping.toString()) == const_594;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1289,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_930).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_48;
         var _loc3_:String = this.var_1247[param1.type];

package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_135:String = "hex";
      ...
      public static const const_1568:String = "float";
      
      public static const const_38:String = "Boolean";
      
      public static const const_1534:String = "bool";
      
      public static const const_52:String = "String";
      
      public static const const_241:String = "Point";
      
      public static const const_227:String = "Rectangle";
      ...
      private static const const_589:String = "value";
      
      private static const const_594:String = "true";
      
      private static const const_1693:String = "FurnitureEcotronBoxLogic";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_589);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_589));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_589)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_215 || _loc5_ == const_140)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_135:
               return uint(param1);
            case const_140:
               return param1.split(const_1249);
            default:
      ...
      public static function parseValueType(param1:XML, param2:String) : Object
      {
         ...
         switch(param2)
         {
            ...
            case const_227:
               ...
               _loc5_.width = Number(param1.attribute(const_1250));
               _loc5_.height = Number(param1.attribute(const_1248));
               return _loc5_;
            case const_140:
               _loc3_ = new Map();

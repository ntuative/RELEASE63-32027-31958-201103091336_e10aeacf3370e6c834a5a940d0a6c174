package com.sulake.core.assets
{
   ...
   public class FontAsset implements IAsset
   {
      ...
      protected var var_1542:AssetTypeDeclaration;
      
      protected var var_170:Font;
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         try
         {
            if(unknown is Class)
            {
               this.var_170 = Font(FontEnum.registerFont(unknown as Class));
            }
         }
         catch(e:Error)
         {
      ...
      public function setFromOtherAsset(param1:IAsset) : void
      {
         ...
         {
            this.var_170 = FontAsset(param1).var_170;
            return;
         }

package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1000:LoaderContext;
      
      protected var var_444:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1000 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_444 = new AssetLibrary("lib-" + this.var_540++);
         this.var_29.push(this.var_444);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1000;
         }
      ...
      {
         return this.var_444.loadFromResource(param1,param2);
      }
      ...
      {
         return this.var_444.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_444.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_444.createAsset(param1,param2);
      }
      ...
      {
         return this.var_444.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_444.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_444.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_29.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_444.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_29.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)

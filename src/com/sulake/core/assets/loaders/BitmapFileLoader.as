package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_999 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_42 = new Loader();
         this.var_1000 = new LoaderContext();
         this.var_1000.checkPolicyFile = true;
         ...
         {
            this.var_42.load(param2,this.var_1000);
         }
      }
      ...
      {
         this.var_999 = param1.url;
         var_321 = 0;
         this.var_42.load(param1,this.var_1000);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_321 < var_2781)
            {
               ...
               this.var_42.load(new URLRequest(this.var_999 + (this.var_999.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_321),this.var_1000);
               return true;
            }
         }
         return false;

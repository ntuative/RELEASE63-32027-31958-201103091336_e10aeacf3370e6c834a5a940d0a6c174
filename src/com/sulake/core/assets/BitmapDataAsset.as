package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_457:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_457 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_98 is BitmapDataAsset)
         {
            ...
            this.var_1269 = BitmapDataAsset(this.var_98).var_1269;
            this.var_1268 = BitmapDataAsset(this.var_98).var_1268;
            if(this._bitmap != null)
            {
               this.var_98 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1269 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1268 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }

   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_256 != null)
         {
            ...
            {
               _loc3_ = this.var_256.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1343.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1343.push(param1);
         }
         if(this.var_573[param1] != param2)
         {
            this.var_573[param1] = param2;
         }
      }
      ...
      {
         if(this.var_1342.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_598.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_598[_loc2_]);
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         {
            return this.var_256.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_256.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_256.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_256.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_256.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }

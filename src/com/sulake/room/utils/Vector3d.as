package com.sulake.room.utils
{
   public class Vector3d implements IVector3d
   {
      ...
      public function get length() : Number
      {
         ...
         {
            this._length = Math.sqrt(this._x * this._x + this.var_142 * this.var_142 + this.var_143 * this.var_143);
         }
         return this._length;
      }
      ...
      {
         return "(" + [this._x,this.var_142,this.var_143].join(",") + ")";
      }
   }
}

package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_686:int = -1;
      ...
      private var var_2851:IRoomContentLoader;
      
      private var var_624:IRoomObjectFactory = null;
      
      private var var_507:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1180:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_623 = [];
         this.var_598 = [];
         events.addEventListener(RoomContentLoadedEvent.const_373,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_528,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_777,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_624 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_624 == null || this.var_507 == null)
         {
            return;
         }
         this._state = const_1387;
         if(this.var_1180 != null)
         {
            _loc1_ = this.var_1180;
            this.var_1180 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_623.indexOf(_loc5_) < 0)
            {
      ...
      public function method_8(param1:IRoomContentLoader) : void
      {
         if(this.var_52 != null)
         {
            this.var_52.dispose();
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_598.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_598[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_507.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_507.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_624.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_624 != null)
         {
            return this.var_624.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_686)
         {
            return;
         }
         if(this.var_52 == null)
         {
            this._state = const_686;
            return;
         }
         if(this.var_52.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_623.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_623.splice(_loc2_,1);
            }
            if(this.var_623.length == 0)
            {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_52 == null || this.var_507 == null)
         {
            return;
         }
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_507.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_507.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_624.createRoomObjectLogic(_loc18_);

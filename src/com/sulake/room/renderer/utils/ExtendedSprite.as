package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1410:int = 128;
      
      private var var_1409:Boolean = false;
      
      private var var_2810:Point;
      ...
      {
         if(param1 != this.var_1785 || param2 != this.var_1786)
         {
      ...
      {
         if(this.var_1410 > 255 || bitmapData == null)
         {
            return false;
         }

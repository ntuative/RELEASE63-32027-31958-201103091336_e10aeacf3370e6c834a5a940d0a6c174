package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_328:IRoomObjectController;
      ...
      {
         if(this.var_328 == param1)
         {
            return;
         }
         if(this.var_328 != null)
         {
            this.var_328.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_328 = param1;
            this.var_328.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_328 != null)
            {
               this.var_328.setLocation(param1.loc);
               this.var_328.setDirection(param1.dir);
            }
         }
      }
   }

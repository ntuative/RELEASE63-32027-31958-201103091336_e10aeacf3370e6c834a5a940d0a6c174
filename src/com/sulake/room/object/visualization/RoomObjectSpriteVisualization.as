package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_328:IRoomObject;
      
      private var var_724:IGraphicAssetCollection;
      
      protected var var_449:int = -1;
      
      protected var var_169:int = -1;
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_724.removeReference();
         }
         this.var_724 = param1;
         if(this.var_724 != null)
         {
            this.var_724.addReference();
         }
      }
      ...
      {
         this.var_449 = 4294967295;
         this.var_169 = 4294967295;
         this.var_187 = -1;
      }

package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1732:int = 255;
      
      private var var_1472:uint = 16777215;
      
      private var var_1893:int = 255;
      
      private var var_1187:uint = 16777215;
      
      private var var_1891:int = 255;
      
      private var var_1188:int = 0;
      
      private var var_1892:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_856,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_769,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_841,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_714,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1188)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1732;
            if(_loc2_ - this.var_1188 >= this.var_1892)
            {
               _loc3_ = this.var_1187;
            ...
            else
            {
               ...
               _loc10_ = this.var_1187 >> 16 & 255;
               _loc11_ = this.var_1187 >> 8 & 255;
               _loc12_ = this.var_1187 & 255;
               _loc13_ = (_loc2_ - this.var_1188) / this.var_1892;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1893 + (this.var_1891 - this.var_1893) * _loc13_;
               this._color = _loc3_;
               this.var_1732 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_856,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_716:
               param2.setString(RoomObjectVariableEnum.const_765,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_858:
               param2.setString(RoomObjectVariableEnum.const_859,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_853:
               param2.setString(RoomObjectVariableEnum.const_793,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_529:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_257)
               {
                  _loc5_ = "null";
               }
               this.var_470.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_779:
               _loc4_ = this.var_470.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_470.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1190:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1174:
               param2.setNumber(RoomObjectVariableEnum.const_841,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_714,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1134,int(param1.bgOnly));
         this.var_1472 = this._color;
         this.var_1893 = this.var_1732;
         this.var_1187 = _loc3_;
         this.var_1891 = _loc4_;
         this.var_1188 = getTimer();
         this.var_1892 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_527,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1677,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1512,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1513,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_527,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_158 || _loc13_ == RoomPlaneData.const_292)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {

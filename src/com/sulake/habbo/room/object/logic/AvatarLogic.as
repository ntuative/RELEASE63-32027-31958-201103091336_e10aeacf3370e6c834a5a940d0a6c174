package com.sulake.habbo.room.object.logic
{
   ...
   public class AvatarLogic extends MovingObjectLogic
   {
      ...
      private static const const_958:Number = 1.5;
      ...
      private static const const_1352:int = 999999999;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarChatUpdateMessage)
         {
            ...
            this.var_1348 = getTimer() + _loc4_.numberOfWords * 1000;
            return;
         }
         if(param1 is RoomObjectAvatarTypingUpdateMessage)
         {
            _loc5_ = param1 as RoomObjectAvatarTypingUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_987,Number(_loc5_.isTyping));
            return;
         }
         if(param1 is RoomObjectAvatarUpdateMessage)
         {
            _loc6_ = param1 as RoomObjectAvatarUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_320,_loc6_.dirHead);
            return;
         }
         ...
         if(param1 is RoomObjectAvatarDanceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_1017,_loc9_.danceStyle);
            return;
         }
         if(param1 is RoomObjectAvatarSleepUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarSleepUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_389,Number(_loc10_.isSleeping));
            return;
         }
         if(param1 is RoomObjectAvatarPlayerValueUpdateMessage)
         {
            _loc11_ = param1 as RoomObjectAvatarPlayerValueUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_741,_loc11_.value);
         ...
         if(param1 is RoomObjectAvatarCarryObjectUpdateMessage)
         {
            ...
            if(_loc15_.itemType < const_1352)
            {
               this.var_962 = getTimer() + 100000;
               this.var_1871 = true;
            }
            else
            {
               this.var_962 = getTimer() + 1500;
               this.var_1871 = false;
            }
            return;
         }
         if(param1 is RoomObjectAvatarUseObjectUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_405,_loc16_.itemType);
            return;
         }
         if(param1 is RoomObjectAvatarSignUpdateMessage)
         {
            _loc17_ = param1 as RoomObjectAvatarSignUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_1012,_loc17_.signType);
            this.var_1459 = getTimer() + 5000;
            return;
         }
         if(param1 is RoomObjectAvatarFlatControlUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_1398,Number(_loc18_.isAdmin));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1176,_loc22_);
            return;
         }
      ...
      private function updateEffect(param1:int, param2:int, param3:IRoomObjectModelController) : void
      {
         if(param1 == const_959)
         {
            this.var_769 = getTimer() + const_957;
            this.var_1458 = const_956;
         }
         else if(param3.getNumber(RoomObjectVariableEnum.const_558) == const_956)
         {
            this.var_769 = getTimer() + const_957;
         ...
         else
         {
            if(param2 != 0)
            {
               this.var_769 = getTimer() + param2;
               this.var_1458 = param1;
               return;
            }
            this.var_769 = 0;
         }
         param3.setNumber(RoomObjectVariableEnum.const_558,param1);
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(param1.type)
         {
            case MouseEvent.CLICK:
               ...
               if(eventDispatcher != null)
               {
                  _loc5_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_255,param1.eventId,_loc3_,_loc4_,param1.altKey,param1.ctrlKey,param1.shiftKey,param1.buttonDown);
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         if(this.var_1348 > 0)
         {
            ...
            {
               param2.setNumber(RoomObjectVariableEnum.const_221,1);
               this.var_961 = 0;
            }
         }
         ...
         if(this.var_1459 > 0 && param1 > this.var_1459)
         {
            param2.setNumber(RoomObjectVariableEnum.const_1012,0);
            this.var_1459 = 0;
         }
         if(this.var_962 > 0)
         {
            if(param1 > this.var_962)
            {
               param2.setNumber(RoomObjectVariableEnum.const_439,0);
               this.var_962 = 0;
            }
            else if((this.var_962 - param1) % 10000 < 1000 && this.var_1871)
            {
               param2.setNumber(RoomObjectVariableEnum.const_405,1);
            }
            else
            {
         ...
         if(param1 > this.var_1872)
         {
            ...
            this.var_1460 = param1 + this.getBlinkLength();
         }
         ...
         if(this.var_769 > 0 && param1 > this.var_769)
         {
            param2.setNumber(RoomObjectVariableEnum.const_558,this.var_1458);
            this.var_769 = 0;
         }
         if(this.var_1461 > 0 && param1 > this.var_1461)
         {
            param2.setNumber(RoomObjectVariableEnum.const_741,0);
            this.var_1461 = 0;
         }
      }
      ...
      private function targetIsWarping(param1:IVector3d) : Boolean
      {
         ...
         if(Math.abs(_loc2_.x - param1.x) > const_958 || Math.abs(_loc2_.y - param1.y) > const_958)
         {
            return true;
         }
         return false;

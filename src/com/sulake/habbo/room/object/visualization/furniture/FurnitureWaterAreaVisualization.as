package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1351:String = "shore";
      ...
      {
         if(this.var_2615 == param1 && this.var_2614 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,_direction,_loc2_) == const_1351)
            {
               this.var_1836 = _loc2_;
               this.var_2615 = param1;
               this.var_2614 = _direction;
               return this.var_1836;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1158.indexOf(_loc2_) < 0)
            {
               this.var_1158.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_496 == 0 || this.var_614 == 0)
         {
            ...
            this.var_496 = _loc2_.getNumber(RoomObjectVariableEnum.const_325);
            this.var_614 = _loc2_.getNumber(RoomObjectVariableEnum.const_351);
         }
         this.var_424 = [];
         this.var_613 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_496 * 2 + this.var_614 * 2)
         {
            this.var_424.push(false);
            this.var_613.push(ShoreMaskCreatorUtility.const_79);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_71,getSize(param3),this.var_424,this.var_613,assetCollection);
      }

package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1657:String = "cone";
      
      public static const const_1465:String = "plane";
      
      public static const const_1532:String = "sphere";
       
      
      private var _name:String;
      
      private var var_2598:int = -1;
      
      private var var_2597:Number;
      
      private var _direction:Vector3D;
      
      private var var_943:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_944 = 0;
         this.var_949 = false;
         this.init(0,0,0,this._direction,this.var_2597,this.var_943,this.var_2599,true);
      }
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2596)
         {
            switch(this.var_2601)
            {
               case const_1657:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_943,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_944 < this.var_1439)
         {
            if(this.age % this.var_2600 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_944 < this.var_1439)
         {
            ...
            this.y = (2 - this.var_264) * this.y - (1 - this.var_264) * this.lastY + this.var_1823 * this.var_943 * this.var_943;
         ...
         for each(_loc2_ in this.var_369)
         {
            ...
            _loc2_.y = (2 - this.var_264) * _loc2_.y - (1 - this.var_264) * _loc2_.lastY + this.var_1823 * this.var_943 * this.var_943;

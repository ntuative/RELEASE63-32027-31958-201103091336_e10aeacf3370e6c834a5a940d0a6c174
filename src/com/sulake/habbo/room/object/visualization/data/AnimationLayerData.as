   ...
   public class AnimationLayerData
   {
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!this.var_1666)
         {
            ...
            _loc6_ = 0;
            _loc6_ = 0;
            while(_loc6_ < this.var_226.length)
            {
               _loc2_ = this.var_226[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc7_ = this.var_226.length * Math.random();
         _loc2_ = this.var_226[_loc7_] as AnimationFrameSequenceData;
      ...
      public function getFrameFromSequence(param1:int, param2:int, param3:int) : AnimationFrame
      {
         ...
         var _loc4_:AnimationFrameSequenceData = this.var_226[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:Boolean, param4:int) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc10_ = false;
            if(!this.var_1666 && !param2.isRandom)
            {
               if(param4 == this.var_226.length - 1 && param1 == param2.frameCount - 1)
               {
                  _loc10_ = true;
               }
            }

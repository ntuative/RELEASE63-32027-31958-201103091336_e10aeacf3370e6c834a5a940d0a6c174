package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_930:IPlaneRasterizer = null;
      
      private var var_708:PlaneMaskManager = null;
      ...
      private var var_419:PlaneBitmapData = null;
      ...
      private var var_744:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_301.assign(param3);
         this.var_300 = new Vector3d();
         this.var_300.assign(param4);
      ...
      {
         return this._isVisible && this.var_744;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_930.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_419;
         if(_loc3_ == null)
         {
         ...
         if(this.var_744 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_360))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_301.length * param1.scale;
            _loc6_ = this.var_300.length * param1.scale;
            ...
            if(this.var_930 != null)
            {
               _loc3_ = this.var_930.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1798,this.var_2560,this.var_2558,this.var_2559,this.var_2556,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1758 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_744)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1311.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1311[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            this.var_2489 = relativeDepth;
            this._isVisible = true;
            this.var_1758 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2557);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_124 || this._type == const_95)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_124 || this._type == const_95))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_261.length == this.var_931.length)
         {
            while(_loc1_ < this.var_261.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_931.length)
                  {
                     _loc7_ = this.var_931[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_359.length > this.var_1421.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_932 || this.var_261.length == 0 && this.var_359.length == 0 && !this.var_360 || this.var_708 == null)
         {
            return;
         }
         ...
         if(this.var_360)
         {
            ...
            while(_loc5_ < this.var_261.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc3_.leftSideLoc / this.var_301.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc3_.rightSideLoc / this.var_300.length;
                  _loc12_ = _loc3_.type;
                  this.var_708.updateMask(this.var_71,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_931.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_359.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc4_.leftSideLoc / this.var_301.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc4_.rightSideLoc / this.var_300.length;
                  _loc13_ = this.var_71.width * _loc4_.leftSideLength / this.var_301.length;
                  _loc14_ = this.var_71.height * _loc4_.rightSideLength / this.var_300.length;
                  this.var_71.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1421.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_360 = false;

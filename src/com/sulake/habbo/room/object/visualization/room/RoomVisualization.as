package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1561:int = 16777215;
      
      public static const const_1435:int = 13421772;
      
      private static const const_926:int = 16777215;
      
      private static const const_925:int = 13421772;
      
      private static const const_924:int = 10066329;
      
      private static const const_923:int = 10066329;
      
      public static const const_1396:int = 16777215;
      
      public static const const_1644:int = 13421772;
      
      public static const const_1477:int = 10066329;
      ...
      private var var_692:Rectangle = null;
      
      private var var_470:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_1055:uint = 16777215;
      
      private var var_2265:int = 255;
      
      private var var_2266:int = 255;
      
      private var var_2264:int = 255;
      ...
      private const const_1998:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_470 = new RoomPlaneBitmapMaskParser();
         this.var_291["null"] = false;
         this.var_291["null"] = true;
         this.var_291["null"] = true;
         this.var_291["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_132.length)
            {
               _loc4_ = this.var_132[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_692 = super.boundingRectangle;
         }
         return new Rectangle(this.var_692.x,this.var_692.y,this.var_692.width,this.var_692.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_132.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_132[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1033);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_182)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1561;
               }
               else
               {
                  _loc13_.color = const_1435;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_158)
            {
               ...
               {
                  _loc13_.color = const_926;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_925;
               }
               else
               {
                  _loc13_.color = const_924;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_292)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1396;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1644;
               }
               else
               {
                  _loc13_.color = const_1477;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1573)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_124,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1998 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         if(_loc7_)
         {
            ...
            {
               _loc10_ = this.var_564[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_334[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_95)
               {
                  if(this.var_1637)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2264 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2266 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2265 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1758)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1395 || _loc3_.y != this.var_2262 || _loc3_.z != this.var_2268 || param1.scale != this.var_2263))
            {
               this.var_1395 = _loc3_.x;
               this.var_2262 = _loc3_.y;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_169 != param1.getUpdateID())
         {
            ...
            if(_loc3_ != this.var_2267)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2267 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_856));
            if(_loc4_ != this.var_1055)
            {
               this.var_1055 = _loc4_;
               this.var_2264 = this.var_1055 & 255;
               this.var_2266 = this.var_1055 >> 8 & 255;
               this.var_2265 = this.var_1055 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1134));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_169 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_859);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_765);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_793);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_769));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_841));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_714));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_132.length)
         {
            _loc5_ = this.var_132[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      {
         if(param1 != this.var_291["null"] || param2 != this.var_291["null"] || param3 != this.var_291["null"])
         {
            this.var_291["null"] = param1;
            this.var_291["null"] = param2;
            this.var_291["null"] = param3;
            this.var_334 = [];
            this.var_564 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_334;
         if(this.var_334.length == 0)
         {
            _loc6_ = this.var_132;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_334.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_291[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_334.push(_loc12_);
                        this.var_564.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1638;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_470.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_132.length)
         {
            _loc3_ = this.var_132[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_470.maskCount)
         {
            _loc10_ = this.var_470.getMaskType(_loc8_);
            _loc11_ = this.var_470.getMaskLocation(_loc8_);
            _loc12_ = this.var_470.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_132.length)
               {
                  _loc3_ = this.var_132[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_124 || _loc3_.type == RoomPlane.const_95)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_124 || _loc3_.type == RoomPlane.const_95 && _loc12_ == RoomPlaneBitmapMaskData.const_257)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_132[_loc18_] as RoomPlane;

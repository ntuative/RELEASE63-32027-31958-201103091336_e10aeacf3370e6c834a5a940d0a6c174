package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_724:IGraphicAssetCollection;
      
      private var var_1681:XMLList;
      
      private var _offsetX:int;
      
      private var var_1118:int;
      
      private var var_2469:Vector3d;
      ...
      private var var_905:Boolean = true;
      ...
      private var var_1391:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_906)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1391 = this.var_43.getValue(this.var_906);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2469 = new Vector3d(-0.5,0.5,0);
         this.var_905 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2469);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1115.x = _loc3_.x;
         this.var_1115.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_43.getValue(this.var_906);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1755 = RoomObjectVariableEnum.const_1097;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1755 = RoomObjectVariableEnum.const_1009;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1114 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1114 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_43.getValue(this.var_906);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2467 && param3 == this.var_2468)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1114 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1114 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1755);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_512;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1391.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_724.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1115.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1115.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_407.indexOf(_loc10_) >= 0 && this.var_905)
            {
               param1 = this.var_407.indexOf(_loc10_);
               if(this.var_594[param1] != "")
               {
                  _loc9_ = this.var_724.getAsset(this.var_594[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }

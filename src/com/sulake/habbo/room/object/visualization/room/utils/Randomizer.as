package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1949:int = 1;
      
      public static const const_1749:int = 16777216;
      ...
      private var var_1768:int = 16777216;
      
      private var var_2806:int = 69069;
      
      private var var_2807:int = 5;
      ...
      {
         var _loc1_:int = this.var_2806 * this.var_1767 + this.var_2807;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1768;
         this.var_1767 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1768 * param2);
      }
   }
}

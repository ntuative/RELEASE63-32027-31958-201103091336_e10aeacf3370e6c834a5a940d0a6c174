package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_591:int = 1;
      
      private static const const_918:int = 1000;
      
      private static const const_1258:String = "pet_experience_bubble_png";
      
      private static const const_1256:int = 0;
      ...
      private var var_285:AnimatedPetVisualizationData = null;
      ...
      public function AnimatedPetVisualization()
      {
         this.var_108 = [];
         super();
         while(this.var_108.length < ANIMATION_INDEX_COUNT)
         {
            this.var_108.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_108 != null)
         {
            ...
            {
               _loc2_ = this.var_108[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_285 = param1 as AnimatedPetVisualizationData;
         var _loc2_:* = null;
         if(this.var_285.commonAssets != null)
         {
            _loc3_ = this.var_285.commonAssets.getAssetByName(const_1258) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_362);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_237);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_389) > 0;
            this.var_1773 = _loc3_.getNumber(RoomObjectVariableEnum.const_320);
            this.var_1285 = _loc3_.getNumber(RoomObjectVariableEnum.const_883);
            this.var_2142 = _loc3_.getNumber(RoomObjectVariableEnum.const_771);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1580)
            {
               this.var_1580 = _loc6_;
               this.var_2143 = this.var_1580.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1285 > 0)
            {
               _loc2_ = param1 - this.var_1285;
               if(_loc2_ < const_918)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_918 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         {
            this.var_270 = param1;
            _loc3_ = this.var_285.getAnimationForPosture(var_187,param1);
            this.setAnimationForIndex(const_1256,_loc3_);
         }
         if(param2 != this.var_1404)
         {
            this.var_1404 = param2;
            _loc3_ = this.var_285.getAnimationForGesture(var_187,param2);
            this.setAnimationForIndex(const_1257,_loc3_);
         }
      }
      
      override protected function getAdditionalSpriteCount() : int
      {
         return super.getAdditionalSpriteCount() + const_591;
      }
      ...
      {
         var _loc2_:* = null;
         var _loc1_:int = this.var_108.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_108[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function updateAnimations(param1:Number) : Array
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_108.length)
         {
            _loc6_ = this.var_108[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_108.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_108[_loc5_];
            if(_loc6_ != null)
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2143);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_591)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_591))
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_559.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_559[param2];
               if(_loc4_ == 1)
               {

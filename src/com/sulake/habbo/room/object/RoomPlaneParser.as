package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_131:Number = 0.0;
      
      private var var_887:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         this._width = param1;
         this._height = param2;
         this.var_519 = this._width;
         this.var_521 = -1;
         this.var_520 = this._height;
         this.var_518 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this._width && param2 >= 0 && param2 < this._height)
         {
            ...
            if(param3 >= 0)
            {
               if(param1 < this.var_519)
               {
                  this.var_519 = param1;
               }
               if(param1 > this.var_521)
               {
                  this.var_521 = param1;
               }
               if(param2 < this.var_520)
               {
                  this.var_520 = param2;
               }
               if(param2 > this.var_518)
               {
                  this.var_518 = param2;
               }
            }
            ...
            {
               if(param1 == this.var_519 || param1 == this.var_521)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_520;
                  while(_loc6_ < this.var_518)
                  {
               ...
               if(param2 == this.var_520 || param2 == this.var_518)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_519;
                  while(_loc8_ < this.var_521)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         this.var_887 = getFloorHeight(this.var_160);
         if(!param1)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_158,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_131) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_158,Vector3d.sum(param1,Vector3d.product(param3,-this.var_131 / param3.length)),Vector3d.product(param3,(param3.length + this.var_131) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_182,_loc13_,new Vector3d(0,0,-this.var_131),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_131,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,this.var_131,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_182,_loc13_,new Vector3d(0,0,-this.var_131),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_131,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,this.var_131,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_182,_loc13_,new Vector3d(0,0,-this.var_131),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_131,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,this.var_131,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_182,_loc13_,new Vector3d(0,0,-this.var_131),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_131,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,this.var_131,param11);
                  }
               }
            }
         }
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_132[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1211;
         }
         var _loc2_:RoomPlaneData = this.var_132[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_132[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {

package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_747:String = "RCL_LOADER_READY";
      
      private static const const_331:String = "RCL_PUBLICROOM_";
      
      private static const const_1730:int = 0;
      
      private static const const_963:int = 1;
      
      private static const name_3:int = 2;
      
      private static const const_418:String = "place_holder";
      
      private static const const_609:String = "wall_place_holder";
      
      private static const const_607:String = "pet_place_holder";
      ...
      private static const const_962:String = "selection_arrow";
      ...
      private var var_969:Map = null;
      
      private var var_435:Dictionary;
      
      private var var_970:Map = null;
      
      private var var_202:PublicRoomData = null;
      
      private var var_1473:Map = null;
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2674 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2675 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2672 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2673 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_288.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_775.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_434.add(_loc3_,_loc4_);
               if(this.var_376[_loc7_] == null)
               {
                  this.var_376[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_629.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_628.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_628.remove(_loc7_);
               this.var_628.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2676)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_747));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_512 != null)
         {
            this.var_512.remove(param2);
            this.var_512.add(param2,param1);
         }
      }
      ...
      {
         return [const_418,const_609,const_607,const_608,TILE_CURSOR,const_962];
      }
      ...
      {
         var _loc3_:String = this.var_629.getValue(param1) as String;
      ...
      {
         return this.var_969.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_970[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_629.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_775.getValue(param1) != null)
         {
            return this.var_775.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_202 != null && this.var_202.hasWorldType(const_331 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_175 || param1 == RoomObjectVisualizationEnum.const_72 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_29 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_628.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2673 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_29:
                     if(this.var_376[_loc4_] == null)
                     {
                        this.var_376[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_373,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1473.getValue(param1) != null)
         {
            this.var_202 = this.var_1473.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_740,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2674.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1663);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_373,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_528,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_970.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1473.add(param1,_loc4_);
         this.var_202 = _loc4_;
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_230 && _loc5_ != RoomObjectLogicEnum.const_175)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_507.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(this.getObjectCategory(const_331 + param1) == RoomObjectCategoryEnum.const_76)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_202.getWorldHeightScale(const_331 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_202 != null)
         {
            return this.var_202.getWorldScale(const_331 + param1);
         }
         return 32;
      }

package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_443:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_148.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_137,HabboWindowStyle.const_42,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1705,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_148.habboConfiguration.getKey("use.sso","FurnitureEcotronBoxLogic") == "true")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1705,"/");
         ...
         {
            dispatchEvent(new Event(const_443));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_128.removeEventListener(SSOTicket.const_370,this.onParsedTicketSuccess);
            this.var_128.removeEventListener(SSOTicket.const_318,this.onParsedTicketFailure);
            this.var_128 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_128 = new SSOTicket(this.var_148.assets,_loc3_,_loc2_,param1);
         this.var_128.addEventListener(SSOTicket.const_370,this.onParsedTicketSuccess);
         this.var_128.addEventListener(SSOTicket.const_318,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_148.shockwaveClientUrl = this.var_128.shockwaveClientUrl;
         this.var_148.ssoTicket = this.var_128.ticket;
         this.var_128.removeEventListener(SSOTicket.const_370,this.onParsedTicketSuccess);
         this.var_128.removeEventListener(SSOTicket.const_318,this.onParsedTicketFailure);
         this.var_128 = null;
         dispatchEvent(new Event(const_443));

package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_482:IKeyExchange;
      
      private var var_892:String;
      
      private var var_17:HabboLoginDemoView;
      
      private var var_2420:PseudoRandom;
      ...
      private const const_1705:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_589 = param1;
            this.var_54.initConnection(HabboConnectionType.const_246);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_98,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_54 && this.var_149 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_222 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_222.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_149.getKey("use.sso.ticket") == "1";
         this.var_589 = this.var_149.getKey("sso.ticket",null);
         this.var_1731 = this.var_149.getKey("flash.client.url","");
         this.var_2422 = this.var_149.getKey("external.variables.txt","");
         if(this.var_222 == null)
         {
            this.var_222 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_54.mode = HabboConnectionType.const_90;
            if(this.var_589)
            {
               this.var_54.initConnection(HabboConnectionType.const_246);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this.var_17.addEventListener(HabboLoginDemoView.const_443,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_54.mode = HabboConnectionType.const_1039;
            }
         }
         this.var_54.initConnection(HabboConnectionType.const_246);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_886);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2420 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_54.mode)
         {
            case HabboConnectionType.const_90:
               _loc6_ = "";
               ...
               this.var_222.loadBannerImage(_loc7_ + "?token=" + this.var_1378,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1039:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1399:
               this.var_892 = this.generateRandomHexString(30);
               this.var_482 = new DiffieHellman(new BigInteger(this.var_149.getKey("connection.development.prime"),16),new BigInteger(this.var_149.getKey("connection.development.generator"),16));
               this.var_482.init(this.var_892);
               _loc8_ = this.var_482.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_482.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_482.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2420);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1731,this.var_2422));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1705,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_589 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_589);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2421)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1378);
         ...
         this.var_482 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_482.init(_loc14_);
            _loc15_ = this.var_482.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_892 = _loc14_;
            }

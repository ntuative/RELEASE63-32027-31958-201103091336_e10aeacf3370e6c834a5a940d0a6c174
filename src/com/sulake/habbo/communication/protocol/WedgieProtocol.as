package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1598:uint = 1;
      
      public static const const_1428:uint = 2;
       
      
      private var var_1455:IProtocolEncoder;
      
      private var var_1052:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1455 = new WedgieEncoder();
         this.var_1052 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1598)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1052.getID(_loc4_);

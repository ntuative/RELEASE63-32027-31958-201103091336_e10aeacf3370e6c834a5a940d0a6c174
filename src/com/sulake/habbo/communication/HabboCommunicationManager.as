package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      private const const_2002:int = 2;
      ...
      private var var_1373:IMessageConfiguration;
      ...
      {
         this.var_1373 = new HabboMessages();
         this.var_254 = [];
         this.var_1361 = new Timer(100,1);
      ...
      {
         if(this.var_254.length == 0 || this.var_398 < 0 || this.var_398 >= this.var_254.length)
         {
            return 0;
         }
         return this.var_254[this.var_398];
      }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_293.registerProtocolType(HabboProtocolType.const_1086,WedgieProtocol);
            this._connection = this.var_293.createConnection(HabboConnectionType.const_246,ConnectionType.const_1151);
            _loc3_ = this.var_293.getProtocolInstanceOfType(HabboProtocolType.const_1086);
            this._connection.registerMessageClasses(this.var_1373);
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_254 = [];
            this.var_37 = this.var_149.getKey("connection.info.host",null);
            if(this.var_37 == null)
            {
            ...
            {
               this.var_37 = this.var_149.getKey("connection.info.host.local");
      ...
      public function initConnection(param1:String) : void
      {
         switch(param1)
         {
            case HabboConnectionType.const_246:
      ...
      private function nextPort() : void
      {
         ...
         ++this.var_398;
         if(this.var_398 >= this.var_254.length)
         {
            ErrorReportStorage.addDebugData("ConnectionRetry","Connection attempt " + this.var_884);
            ++this.var_884;
            _loc1_ = this.const_2002;
            if(this.var_254.length == 1)
            {
               _loc1_++;
            }
            if(this.var_884 > _loc1_)
            {
               if(this.var_2395)
               {
                  return;
               ...
               this.var_2395 = true;
               Core.error("Connection failed to host " + this.var_37 + " ports " + this.var_254,true,Core.const_277);
               return;
            }
            this.var_398 = 0;
         }
         this._connection.timeout = this.var_884 * 10000;
         this._connection.init(this.var_37,this.var_254[this.var_398]);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication IO Error","IOError " + param1.type + " on connect: " + param1.text + ". Port was " + this.var_254[this.var_398]);
         this.tryNextPort();
      }
      
      private function onConnect(param1:Event) : void
      {
         ErrorReportStorage.addDebugData("Connection","Connected with " + this.var_884 + " attempts");
      }
      
      private function tryNextPort() : void
      {
         this.var_1361.addEventListener(TimerEvent.TIMER,this.onTryNextPort);
         this.var_1361.start();
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication Security Error","SecurityError on connect: " + param1.text + ". Port was " + this.var_254[this.var_398]);
         this.tryNextPort();
      }
      
      public function getHabboMainConnection(param1:Function) : IConnection
      {
         return !!this.var_293 ? this.var_293.queueConnection(HabboConnectionType.const_246,param1) : null;
      }
      ...
      public function addHabboConnectionMessageEvent(param1:IMessageEvent) : void
      {
         if(this.var_293)
         {
            this.var_293.addConnectionMessageEvent(HabboConnectionType.const_246,param1);
         }
      }
      ...
      public function connectionInit(param1:String, param2:int) : void
      {
         ...
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1551,String(param2));
      }
      
      public function messageReceived(param1:String, param2:String) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1531,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1630,param1 + " " + param2);

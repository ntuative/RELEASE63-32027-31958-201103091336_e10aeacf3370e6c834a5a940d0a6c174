package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1408:int = 2;
      ...
      private var var_1782:TriggerConfs;
      
      private var var_1784:ActionTypes;
      
      private var var_1783:ConditionTypes;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1133 = new SliderWindowController(this.var_82,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_82.assets,0,20,1);
         this.var_1133.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1133.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_738.hideAll(this.var_259);
         }
      }
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_82.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_36.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_36 as TriggerDefinition != null)
         {
            this.var_82.send(new UpdateTriggerMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_36 as ActionDefinition != null)
         {
            this.var_82.send(new UpdateActionMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_36 as ConditionDefinition != null)
         {
            this.var_82.send(new UpdateConditionMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1133.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_124.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1408) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1408 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_82.send(new ApplySnapshotMessageComposer(this.var_36.id));
      }

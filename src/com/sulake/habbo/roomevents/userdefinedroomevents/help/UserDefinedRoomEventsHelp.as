package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1923 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1207 = this.var_1923.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1207)
         {
            this.var_1207.procedure = this.onButtonClick;
         }
         this.var_1206 = this.var_1923.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1206)
         {
      ...
      {
         if(this.var_273 >= this.var_76.length - 1)
         {
      ...
      {
         ++this.var_273;
         this.var_273 = Math.min(this.var_273,this.var_76.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_76[this.var_273][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_76[this.var_273][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_76[this.var_273][1]).value;

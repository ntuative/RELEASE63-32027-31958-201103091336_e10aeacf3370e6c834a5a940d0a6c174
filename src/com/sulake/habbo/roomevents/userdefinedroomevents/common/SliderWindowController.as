package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_646:Number = 0.0;
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_983);
         }
      ...
      {
         return int(this.var_1808 * (Number(param1 - this._minValue) / (this.var_1214 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1808 * (this.var_1214 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_984)
         {
            if(param1.type == WindowMouseEvent.const_60 || param1.type == WindowMouseEvent.const_200)
            {
               this.var_984 = false;
            }
         }
         if(!this.var_984 || param1.type != WindowEvent.const_403)
         {
            return;
         }
         if(this.var_646 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_646) * this.var_646;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_646 != 0)
            {
               _loc3_ = this.var_983 + this.var_646;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_746 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_746.width,this.var_746.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_746,this.var_746.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_747 != null)
            {
               ...
               this.var_1808 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_746 = BitmapData(_loc2_.content);

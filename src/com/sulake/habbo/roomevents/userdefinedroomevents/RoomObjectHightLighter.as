package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_82.roomEngine.getRoomObject(this.var_82.roomId,this.var_82.roomCategory,param1,RoomObjectCategoryEnum.const_29);
      }

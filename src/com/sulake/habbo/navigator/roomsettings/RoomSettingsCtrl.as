package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_394:IRoomSettingsCtrlOwner;
      ...
      private var var_863:TextFieldManager;
      ...
      private var var_1074:ICheckBoxWindow;
      
      private var var_1079:ICheckBoxWindow;
      
      private var var_572:ICheckBoxWindow;
      ...
      private var var_1082:IWindowContainer;
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1690 = true;
         this.var_394.roomSettingsRefreshNeeded();
      }
      ...
      private function controllerExists(param1:int) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_81.controllers.length)
         {
            _loc3_ = this.var_81.controllers[_loc2_];
      ...
      public function onFlatControllerRemoved(param1:int, param2:int) : void
      {
         ...
         --this.var_81.controllerCount;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_81.controllers.length)
         {
            _loc4_ = this.var_81.controllers[_loc3_];
            if(_loc4_.userId == param2)
            {
               this.var_81.controllers.splice(_loc3_,1);
            }
            else
            {
               _loc3_++;
      ...
      {
         if(param1 != this.var_337 || this.var_1075 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1075 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1517)
         {
            this.var_704.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1481)
         {
            this.var_704.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1590)
         {
            this.var_1076.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1666)
         {
            this.setTagError(this.var_862,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_863,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1672)
         {
            this.setTagError(this.var_862,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_863,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1608)
         {
            this.var_864.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_704.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function clearErrors() : void
      {
         ...
         this.var_862.clearErrors();
         this.var_863.clearErrors();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_704 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1076 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_862 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_863 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_864 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1078 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1077 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1074 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1079 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_572 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1687 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1340 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1081 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1080 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1688 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1339 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_248 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1082 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2331 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2330 = ITextWindow(this._window.findChildByName("advanced_caption"));
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1687.visible = this._inRoom;
         this.var_1688.visible = this._inRoom;
         this.var_2330.visible = this.var_475;
         this.var_2331.visible = !this.var_475;
         if(this.var_475)
         {
            this.var_1080.visible = true;
            this.var_1339.visible = false;
            this.refreshFlatControllers();
            this.var_1080.height = Util.getLowestPoint(this.var_1080) + 4;
         }
         else
         {
            this.populateForm();
            ...
            this.var_1340.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1340.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1081.height = Util.getLowestPoint(this.var_1081) + 4;
         }
         this.var_1689.text = !!this.var_475 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1687.name,this.var_1340.name,this.var_1081.name,this.var_1080.name,this.var_1339.name,this.var_1688.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1690 = false;
         var _loc1_:RoomSettingsData = this.var_81;
         this.var_704.setText(_loc1_.name);
         this.var_1076.setText(_loc1_.description);
         this.var_864.setText("");
         this.var_1078.setText("");
         ...
         this.setTag(this.var_862,_loc1_.tags[0]);
         this.setTag(this.var_863,_loc1_.tags[1]);
         if(this.var_1077)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1074)
         {
            ...
            {
               this.var_1074.select();
            }
            else
            {
               this.var_1074.unselect();
            }
         }
         if(this.var_1079)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.roomId = this.var_81.roomId;
         _loc2_.name = this.var_704.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_584;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_123)
         {
            _loc8_ = this.var_864.getText();
            _loc9_ = this.var_1078.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_864.clearErrors();
               this.var_1078.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         var _loc6_:FlatCategory = this.getFlatCategoryByIndex(this.var_81.categoryId,_loc5_.selection);
         ...
         _loc2_.allowFoodConsume = this.var_1074.isSelected;
         _loc2_.allowWalkThrough = this.var_1079.isSelected;
         _loc2_.hideWalls = this.var_572.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_862,_loc2_.tags);
         this.addTag(this.var_863,_loc2_.tags);
         this.clearErrors();
         this.var_1075 = _loc2_.roomId;
      ...
      private function onDeleteButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_81.name);
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_248.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_248.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_248.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_248.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_248.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_248.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_248.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_248);
         this.var_248.findChildByName("ruler").visible = true;
         this._navigator.registerParameter("navigator.roomsettings.flatctrls.caption","cnt","" + this.var_81.controllerCount);
         _loc4_.visible = true;
         Util.hideChildren(_loc1_);
         var _loc8_:Boolean = false;
         var _loc9_:int = 0;
         while(_loc9_ < this.var_81.controllers.length)
         {
            _loc10_ = this.var_81.controllers[_loc9_];
         ...
         if(this.var_81.controllers.length > 0)
         {
            _loc1_.visible = true;
            _loc7_.visible = true;
            _loc5_.visible = true;
            if(this.var_81.controllerCount > this.var_81.controllers.length)
            {
               this._navigator.registerParameter("navigator.roomsettings.flatctrls.limitinfo","cnt","" + this.var_81.controllers.length);
               _loc6_.visible = true;
            }
            Util.moveChildrenToColumn(this.var_248,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         var _loc2_:* = null;
         for each(_loc2_ in this.var_81.controllers)
         {
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_81.controllers)
         {
            if(_loc1_.selected)
            {
               return true;
      ...
      private function onRemoveFlatCtrlClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:Array = new Array();
         for each(_loc4_ in this.var_81.controllers)
         {
            if(_loc4_.selected)
            {

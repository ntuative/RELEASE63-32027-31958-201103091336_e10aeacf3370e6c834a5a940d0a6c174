package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1017:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_543 = new Timer(100);
         this.var_543.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_41,80,"g"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_41,74,"h"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_41,416,"o"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_41,352,"p"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_41,304,"q"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_41,336,"r"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_41,748,"u"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_41,438,"v"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,540,"t"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,512,"w"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,396,"x"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,440,"y"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,456,"z"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_44,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_543)
         {
            this.var_543.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_543.reset();
            this.var_543 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1017.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1538 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1538 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_170 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_61 = IItemListWindow(this.var_170.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_170.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1018 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_170.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_170.desktop,this.var_170.width,this.var_170.height);
         this.var_170.x = _loc4_.x;
         this.var_170.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1018.goBackToInitialState();
         this.var_1018.input.textBackgroundColor = 4294967295;
         this.var_1017 = this.var_43[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         while(this.var_61.numListItems > 0)
         {
            _loc6_ = this.var_61.removeListItemAt(0);
            _loc6_.destroy();
         }
         for each(_loc1_ in this.var_43)
         {
         ...
         while(_loc4_ < this.var_43.length)
         {
            ...
            if(this.isAllowed(_loc7_))
            {
               ...
               {
                  _loc3_ = this.getRow();
                  this.var_61.addListItem(_loc3_);
               }
         ...
         if(_loc5_)
         {
            ...
            if(_loc8_)
            {
               ...
               this.var_61.addListItem(_loc8_);
            }
         }
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_62,HabboWindowStyle.const_31,HabboWindowParam.const_61,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1018.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_170.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_170.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1018.getText();
         var _loc3_:String = "model_" + this.var_1017.name;

package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_56 == null)
         {
            this.var_56 = IWindowContainer(this._navigator.getXmlWindow(this.var_1006));
            this.var_56.visible = false;
            this.var_56.setParamFlag(HabboWindowParam.const_39,true);
         ...
         this.var_56.x = _loc2_.x + this.var_2286 + param1.width;

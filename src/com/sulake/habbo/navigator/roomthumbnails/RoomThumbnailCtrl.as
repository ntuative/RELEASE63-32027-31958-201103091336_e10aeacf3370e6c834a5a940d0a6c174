package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1858:IButtonWindow;
      
      private var var_1859:IButtonWindow;
      
      private var var_1857:IButtonWindow;
      
      private var var_2634:IWindowContainer;
      
      private var var_2635:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1858 = IButtonWindow(this.find("bg_tab"));
         this.var_1859 = IButtonWindow(this.find("top_tab"));
         this.var_1857 = IButtonWindow(this.find("obj_tab"));
         this.var_2634 = IWindowContainer(this.find("tile_grid"));
         this.var_2635 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1858,this.onBgTabButton);
         Util.setProcDirectly(this.var_1859,this.onTopTabButton);
         Util.setProcDirectly(this.var_1857,this.onObjTabButton);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_68.mode = ThumbnailEditorModel.const_37;
         this.reload();
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_68.mode = ThumbnailEditorModel.const_58;
         this.reload();
      }
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_68.mode = ThumbnailEditorModel.const_34;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1858,this.var_68.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_1859,this.var_68.mode != ThumbnailEditorModel.const_58);
         this.setEnabled(this.var_1857,this.var_68.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2635;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_68.mode == ThumbnailEditorModel.const_37);
         this.refreshEditImg(_loc1_,"edit_top",this.var_68.mode == ThumbnailEditorModel.const_58);
         this.refreshEditImg(_loc1_,"edit_obj",this.var_68.mode == ThumbnailEditorModel.const_34,false);
         if(this.var_68.mode == ThumbnailEditorModel.const_34)
         {
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2634;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_464)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_62,HabboWindowStyle.const_31,HabboWindowParam.const_61,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_579,HabboWindowStyle.const_42,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_290,HabboWindowStyle.const_42,HabboWindowParam.const_61,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));

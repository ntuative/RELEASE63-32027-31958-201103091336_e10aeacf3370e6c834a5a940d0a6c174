package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2852:IWindowContainer;
      
      private var var_515:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_515 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_515.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_515 == null ? 0 : int(this.var_515.selection);
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_742;
         }
         if(param1 == 2)
         {
            return Tabs.const_797;
         }
         if(param1 == 3)
         {
         ...
         if(param1 == 4)
         {
            return Tabs.const_877;
         }
         return Tabs.const_260;
      }
   }
}

package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_527:RoomPopupCtrl;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_527 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_535 = IScrollbarWindow(this.var_170.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         this.var_170.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getVisibleEntryCount() : int
      {
         ...
         {
            if(this.var_61.getListItemAt(_loc2_).visible)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1560,true);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_185)
         {
            this.checkFastHorizontalMove(param1);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(this.var_527.visible && this.var_2716)
            {
               return;
            }
            ...
            this.var_527.room = _loc4_;
            this.var_527.showPopup(param2);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2715 - _loc2_.stageX);
         this.var_2715 = _loc2_.stageX;
         this.var_2716 = _loc3_ > 2;
      }
   }
}

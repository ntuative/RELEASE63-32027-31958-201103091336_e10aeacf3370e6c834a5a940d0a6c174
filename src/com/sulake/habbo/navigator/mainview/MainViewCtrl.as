package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_597:int = 2;
      
      private static const const_935:int = 3;
      
      private static const const_1315:int = 4;
      ...
      private var var_1091:OfficialRoomListCtrl;
      
      private var var_260:ITabContextWindow;
      
      private var var_1701:Boolean;
      
      private var var_580:int;
      
      private var var_1090:Boolean = true;
      
      private var var_1354:int = 0;
      
      private var var_1353:IWindow;
      
      private var var_1092:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1091 = new OfficialRoomListCtrl(this._navigator);
      ...
      public function open() : void
      {
         ...
         if(_loc1_)
         {
            this._navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.NAVIGATOR,this.var_16));
         }
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_260 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         if(!this.var_260)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _tabContext is null!");
         }
         this.var_170 = IWindowContainer(this.var_16.findChildByName("tab_content"));
         this.var_221 = IWindowContainer(this.var_16.findChildByName("custom_content"));
         this.var_195 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_252 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1353 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1092 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1092)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1092.procedure = this.onHotelView;
         this.refreshToHotelViewButton(false);
         this.var_16.procedure = this.onWindow;
         for each(_loc2_ in this._navigator.tabs.tabs)
         {
            _loc3_ = this.var_260.getTabItemByID(_loc2_.id);
            if(!_loc3_)
            {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_786,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1576,true);
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:int = this.var_195.y;
         Util.moveChildrenToColumn(this.var_170,["custom_content","list_content"],this.var_221.y,8);
         this.var_195.height = this.var_195.height + _loc1_ - this.var_195.y - this.var_252.height + this.var_2367;
         Util.moveChildrenToColumn(this.var_170,["list_content","custom_footer"],this.var_195.y,0);
         this.var_2367 = this.var_252.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_260.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_1701 = true;
            this.var_260.selector.setSelected(_loc1_.button);
         }
      }
      ...
      {
         this.refreshList(param1,param2,this.var_1091,"official_rooms");
      }
      ...
      private function refreshList(param1:Boolean, param2:Boolean, param3:IViewCtrl, param4:String) : void
      {
         ...
         {
            _loc5_ = this.var_195.getChildByName(param4);
      ...
      private function getSearchMsg(param1:int, param2:String) : IMessageComposer
      {
         ...
         if(param1 == Tabs.const_877)
         {
            return new MyRoomHistorySearchMessageComposer();
         }
         if(param1 == Tabs.const_260)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_580 == const_936)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_195.blend - _loc2_));
            this.var_195.blend = _loc3_;
            this.var_221.blend = !!this.var_1090 ? Number(_loc3_) : Number(1);
            this.var_252.blend = !!this.var_1090 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_580 = const_597;
            }
         }
         else if(this.var_580 == const_597)
         {
            if(this.var_1354 % 10 == 1)
            {
               this.var_1353.visible = !this.var_1353.visible;
            }
            ++this.var_1354;
            if(!this._navigator.data.isLoading())
            {
               this.var_580 = const_935;
            }
         }
         else if(this.var_580 == const_935)
         {
            this.refresh();
            this.var_580 = const_1315;
         }
         else
         {
      ...
      {
         this._navigator.refreshButton(this.var_1092,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1092,"icon_hotelview_reactive",param1,null,0);
      }

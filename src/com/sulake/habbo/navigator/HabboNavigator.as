package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_560:RoomInfoViewCtrl;
      
      private var var_1037:RoomCreateViewCtrl;
      ...
      private var var_2182:RoomThumbnailRenderer;
      
      private var var_864:GuestRoomPasswordInput;
      
      private var var_319:GuestRoomDoorbell;
      
      private var var_1036:OfficialRoomEntryManager;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_287 = new MainViewCtrl(this);
         this.var_560 = new RoomInfoViewCtrl(this);
         this.var_1037 = new RoomCreateViewCtrl(this);
         this.var_2182 = new RoomThumbnailRenderer(this);
         this.var_864 = new GuestRoomPasswordInput(this);
         this.var_319 = new GuestRoomDoorbell(this);
         this.var_389 = new Tabs(this);
         this.var_1036 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_290,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_560.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_185.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_150,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_185.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_150,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function method_10(param1:IWindowContainer) : void
      {
         if(param1 != null && this.var_185 != null)
         {
            this.var_185.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_287.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_287.startSearch(Tabs.const_250,Tabs.const_340,param1);
         this.var_287.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_287.startSearch(Tabs.const_312,Tabs.const_260);
         this.var_389.getTab(Tabs.const_312).tabPageDecorator.tabSelected();
      }

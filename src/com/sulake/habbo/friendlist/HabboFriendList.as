package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_773:ISessionDataManager;
      
      private var var_2665:FriendListLookAndFeel;
      
      private var var_389:FriendListTabs;
      
      private var var_17:FriendListView;
      
      private var var_1886:OpenedToWebPopup;
      
      private var var_2153:int;
      
      var var_97:FriendCategories;
      
      private var var_374:FriendRequests;
      
      private var var_1885:AvatarSearchResults;
      ...
      {
         this.var_2665 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_97 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1885 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_126)
         {
            this.var_126.release(new IIDHabboMessenger());
            this.var_126 = null;
         }
         if(this.var_182)
         {
         ...
         if(this.var_1033)
         {
            this.var_1033.release(new IIDAvatarRenderManager());
            this.var_1033 = null;
         }
         if(this.var_982)
         {
         ...
         if(this.var_773)
         {
            this.var_773.release(new IIDSessionDataManager());
            this.var_773 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1886 = new OpenedToWebPopup(this);
         }
         this.var_1886.show(x,y);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_100);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_92,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_374.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_185.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_290,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1033.createAvatarImage(param1,AvatarScaleType.const_89,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_126 = param2 as IHabboMessenger;
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1033 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_185 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_773 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_374 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_97.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_97.addCategory(new FriendCategory(FriendCategory.const_1047,this.getText("friendlist.friends")));
         this.var_97.addCategory(new FriendCategory(FriendCategory.const_338,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_97.addFriend(new Friend(_loc4_));
         }
         this.var_389 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_626)
         {
         ...
         this.var_185.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_150,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_97.findCategory(FriendCategory.const_338);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this.var_17.openFriendList();
            _loc1_ = this.var_389.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_393));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_374.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_374.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_389.findTab(FriendListTab.const_97).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_374.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_389.findTab(FriendListTab.const_97);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1885.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_389.findTab(FriendListTab.const_97);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_773 || !this.var_374)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_773.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_374.vipLimit;
         }
         else if(this.var_773.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_41))
         {
            _loc2_ = this.var_374.clubLimit;
         }
         if(_loc2_ > this.var_374.limit)
         {
            this.var_374.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_164) as IBitmapWrapperWindow;

package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1707:String = "noconvinfo";
      ...
      private var var_1364:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1364 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this._friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.FRIENDLIST,this.var_16));
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_883 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_252 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1364.prepare(this.var_883);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1112,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1074,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_888,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_739,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_888,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_739,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1365 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1365.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1716 == -1 ? 0 : int(this.var_16.height - this.var_1716);
         var _loc4_:int = this.var_1714 == -1 ? 0 : int(this.var_16.width - this.var_1714);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1042,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_888,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1112,false);
         ...
         this.var_1716 = this.var_16.height;
         this.var_1714 = this.var_16.width;

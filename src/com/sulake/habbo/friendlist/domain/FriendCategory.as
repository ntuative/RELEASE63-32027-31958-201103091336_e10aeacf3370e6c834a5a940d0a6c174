package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_377:int = 100;
      ...
      {
         if(this.var_913 >= this.getPageCount())
         {
            this.var_913 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_224.length / const_377);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_913 * const_377;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_913 + 1) * const_377,this.var_224.length);
      }

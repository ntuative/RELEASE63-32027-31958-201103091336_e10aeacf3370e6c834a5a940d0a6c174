package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1695:String = "no_reqs_info";
      ...
      {
         this.var_1563 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1562 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1562.procedure = this.onDismissAllButtonClick;
         this.var_1563.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_159)
         {
         ...
         else if(param1.state == FriendRequest.const_368)
         {
         ...
         else if(param1.state == FriendRequest.const_1109)
         {
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         this.var_61.addListItem(param1.view);
         this._friendList.friendRequests.refreshShading();
         this.refreshButtons();
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         this.var_61.removeListItem(param1.view);
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_368;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_313,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_368 && _loc4_.state != FriendRequest.const_375)
            {
               _loc4_.state = FriendRequest.const_375;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_313,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_368 && _loc4_.state != FriendRequest.const_375)
            {
               ...
               _loc4_.state = FriendRequest.const_368;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1563,_loc1_);
         this.setEnabled(this.var_1562,_loc1_);
      }

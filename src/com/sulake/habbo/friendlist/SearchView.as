package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         this.var_703 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_703.procedure = this.onSearchInput;
         this.var_703.addEventListener(WindowKeyboardEvent.const_198,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_61.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_350,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         var _loc10_:IWindowContainer = this.var_61.getListItemAt(param2) as IWindowContainer;
         if(_loc10_ == null)
         {
            if(!param1)
            {
            ...
            this.var_61.addListItem(_loc10_);
         }
         if(param1)
         {
            _loc10_.height = 20;
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_436.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_436.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_61.numListItems)
         {
            if(this.var_61.getListItemAt(_loc2_).id == param1)
            {
               return _loc2_;
            }
            _loc2_++;
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_703.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_703.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_703.text;

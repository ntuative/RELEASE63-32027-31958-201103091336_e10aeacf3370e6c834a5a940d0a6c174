package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      {
         this.dispose();
         this.var_60.closeQuestCompleted(this);
         var _loc3_:String = "catalog.page.quest." + this.var_60.code;
      ...
      private function onQuestCompletedRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_60.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onQuestCompletedRewardImageReady);
         }
      }
      ...
      {
         this.var_213 = IFrameWindow(this.var_60.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         ...
         this.var_60.controller.questEngine.localization.registerParameter(_loc4_ + ".completed.desc","amount",param1.rewardCurrencyAmount.toString());
         this.var_60.controller.questEngine.localization.registerParameter(_loc3_ + ".completed.currency","amount",param1.rewardCurrencyAmount.toString());
         this.var_213.findChildByName("description").caption = this.var_60.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_213.findChildByName("reward.currency.desc").caption = this.var_60.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
         var _loc5_:String = "icon_" + this.var_60.code + "_reward_" + param1.rewardCurrencyAmount;
         var _loc6_:IBitmapWrapperWindow = this.var_213.findChildByName("reward.currency.icon") as IBitmapWrapperWindow;
         this.var_60.controller.questEngine.setImageFromAsset(_loc6_,_loc5_,this.onQuestCompletedRewardImageReady);
      }
   }
}

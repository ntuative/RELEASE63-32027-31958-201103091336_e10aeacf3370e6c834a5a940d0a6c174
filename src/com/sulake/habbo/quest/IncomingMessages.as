package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1868:IAlertDialog;
      ...
      private function setQuestingEnabled(param1:Boolean) : void
      {
         ...
         if(this.var_66.toolbar != null)
         {
            if(param1)
            {
               ...
               _loc4_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_92,HabboToolbarIconEnum.QUESTS);
               _loc4_.iconState = "0";
            ...
            {
               this.var_66.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.QUESTS));
            }
         }
      }

package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_150)
         {
            for each(_loc1_ in this.var_150)
            {
               _loc1_.dispose();
            }
      ...
      {
         var _loc3_:QuestCampaign = this.var_150[param1];
         if(!_loc3_)
         {
            _loc3_ = new QuestCampaign(this,param1);
            this.var_150[param1] = _loc3_;
         }
         if(_loc3_)
         {
      ...
      {
         if(this.var_559 != MODE_TABS)
         {
            this.var_559 = MODE_NO_TABS;
         }
         this.detachCampaign();
         var _loc4_:QuestCampaign = this.var_150[param1];
         if(!_loc4_)
         {
            _loc4_ = new QuestCampaign(this,param1);
            this.var_150[param1] = _loc4_;
         }
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_296.attachTo(this.var_1112);
      ...
      private function updateTabs() : void
      {
         ...
         else if(this.var_150.getKeys().length > 0)
         {
            _loc1_ = this.var_150.getKeys()[0];
         }
         if(_loc1_ != "")
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1112 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_150.getKeys())
         {
            _loc3_ = this.var_150[_loc4_];
            _loc2_ = _loc1_.getTabItemByName("tab_" + _loc4_);
            if(!_loc2_)
            {
               _loc6_ = "quest_" + _loc4_ + ".tab";
               _loc2_ = this.var_66.windowManager.createWindow("tab_" + _loc4_,"${" + _loc6_ + "}",WindowType.const_459) as ITabButtonWindow;
               if(_loc3_.expired)
               {

package com.sulake.habbo.sound.music
{
   ...
   public class RoomItemPlayListController implements IPlayListController, IDisposable
   {
      ...
      private var var_524:HabboMusicController;
      ...
      public function RoomItemPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_758,this.onSongFinishedPlayingEvent);
         this.var_82.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_687,this.onSoundMachinePlayEvent);
         this.var_82.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_811,this.onSoundMachineStopEvent);
         this.var_82.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_639,this.onJukeboxStopEvent);
         this.var_82.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_504,this.onDisposeEvent);
      }
      ...
      {
         return HabboMusicPrioritiesEnum.const_645;
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_758,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_82)
            {
               this.var_82.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_687,this.onSoundMachinePlayEvent);
               this.var_82.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_811,this.onSoundMachineStopEvent);
               this.var_82.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_639,this.onJukeboxStopEvent);
               this.var_82.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_504,this.onDisposeEvent);
               this.var_82 = null;
            }
            this._disposed = true;
         }
      ...
      public function startPlaying() : void
      {
         ...
         if(this.var_95 == null || this.var_95.length == 0)
         {
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         if(this.var_466 == param1)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_524.requestSongInfo(_loc2_.id);
            }
         }
      }
      ...
      {
         this.var_524.stop(HabboMusicPrioritiesEnum.const_645);
         this.var_466 = -1;
         this.var_682 = false;
      }
      ...
      {
         var _loc2_:IHabboSound = this.var_524.getSongObject(this.var_466);
         if(_loc2_ != null)
         {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_524.playSong(param1,this.priority,_loc3_))
         {
      ...
      private function getNextEntry() : PlayListEntry
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_95.length)
         {
            _loc2_ = this.var_95[_loc3_];
         ...
         if(_loc1_ >= this.var_95.length)
         {
            _loc1_ = 0;
         }
         return this.var_95[_loc1_];
      }
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_.current >= 0)
         {
            this.var_524.playSong(_loc3_.current,this.priority,_loc3_.syncCount / 1000);
         }
         if(_loc3_.next >= 0)
         {
            this.var_524.requestSongInfo(_loc3_.next);
         }
         this.var_682 = true;

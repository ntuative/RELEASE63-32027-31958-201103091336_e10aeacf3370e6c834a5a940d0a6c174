package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2814:String = "magic.pixels";
      
      private var var_2815:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         this.var_368 = [];
         this.var_61 = this._container.findChildByName("navigationList") as IItemListWindow;
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in this._index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(this.var_61);
            }
         }
      }
      ...
      {
         this.openPage(this.var_2814);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2815,true);
      }

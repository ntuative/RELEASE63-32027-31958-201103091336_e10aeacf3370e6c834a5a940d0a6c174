package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1323:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1366:XML;
      
      private static var var_1368:XML;
       
      
      private var var_1721:Number = 4.294967295E9;
      ...
      public function addToList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            ...
            param1.addListItem(this.var_61);
         }
      }
      ...
      public function removeFromList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            param1.removeListItem(this.var_61);
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1721 == 4294967295)
            {
               this.var_1721 = _loc1_.color;
            }
            _loc1_.color = const_1323;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1605;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1448;
            }
         }
      }
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(this.var_61);
            }
         }
         if(this.var_61 != null)
         {
            this.var_61.visible = true;
            this.var_61.height = this.var_61.numListItems * 21;
         }
      }
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(this.var_61);
            }
         }
         if(this.var_61 != null)
         {
            this.var_61.height = 0;
      ...
      {
         this.var_61 = navigator.catalog.windowManager.buildFromXML(var_1368) as IItemListWindow;
         if(this.var_61 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1366) as IWindowContainer;
         }
         else
         {

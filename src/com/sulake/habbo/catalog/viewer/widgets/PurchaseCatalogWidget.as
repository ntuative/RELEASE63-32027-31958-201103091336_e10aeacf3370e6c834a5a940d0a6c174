package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_2847:IButtonWindow;
      ...
      private var var_2813:ITextWindow;
      
      private var var_92:Offer;
      
      private var var_2578:String = "";
      
      private var var_1430:Function;
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_873,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2576 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2575 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2577 = _loc3_.content as XML;
         }
         var _loc4_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsOrCreditsAndPixelsStub") as XmlAsset;
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_873,this.onSetParameter);
      ...
      private function attachStub(param1:String) : void
      {
         ...
         switch(param1)
         {
            case Offer.const_824:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2576) as IWindowContainer;
               break;
            case Offer.const_1195:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2575) as IWindowContainer;
               break;
            case Offer.const_1051:
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _window.removeChild(this.var_936);
         ...
         this.var_1814 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_1813 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_1812 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_2813 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_608 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         if(this.var_608 != null)
         {
            if(this.var_1430 != null)
            {
               this.var_608.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1430);
            }
            else
            {
               this.var_608.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1430);
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_1814 != null)
         {
            ...
            this.var_1814.caption = "${catalog.purchase.price.credits}";
         }
         var _loc3_:String = this.var_92.activityPointType == Purse.const_195 ? "pixels" : "activitypoints";
         if(this.var_1813 != null)
         {
            ...
            this.var_1813.caption = _loc2_.getKey(_loc4_);
         }
         if(this.var_1812 != null)
         {
            ...
            this.var_1812.caption = _loc2_.getKey(_loc4_);
         }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(this.var_92 != null)
         {
            ...
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_92,page.pageId,this.var_2578);
         }
      }
   }
}

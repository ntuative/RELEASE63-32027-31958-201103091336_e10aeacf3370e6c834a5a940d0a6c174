package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1742:String = "default";
      ...
      private var var_1743:String = "1.1";
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1382[this.var_401];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1742);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1383[this.var_403];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1384[this.var_404];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1743);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_899[this.var_401];
         for each(_loc1_ in this.var_182.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(this.var_402 >= 0)
               {
                  _loc9_ = _loc1_.children()[this.var_402];
                  if(_loc9_ != null)
                  {
                     this.var_1742 = _loc9_.@id;
                  }
               }
            }
         }
         ...
         _loc6_ = this.var_1383[this.var_403];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_901[this.var_404];
         for each(_loc1_ in this.var_182.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               ...
               if(_loc13_ != null)
               {
                  this.var_1743 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1384[this.var_404];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_205:
               ...
               if(this.var_401 < 0)
               {
                  this.var_401 = this.var_899.length - 1;
               }
               if(this.var_401 == this.var_899.length)
               {
                  this.var_401 = 0;
               }
               this.var_402 = 0;
               this.var_900 = 0;
               _loc5_ = this.var_899[this.var_401];
               for each(_loc8_ in this.var_182.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_900 = _loc8_.children().length();
                  }
               }
            ...
            case const_204:
               ...
               for each(_loc9_ in this.var_182.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_898 = _loc9_.children().length();
                  }
               }
            ...
            case const_95:
               ...
               if(this.var_404 < 0)
               {
                  this.var_404 = this.var_901.length - 1;
               }
               if(this.var_404 >= this.var_901.length)
               {
                  this.var_404 = 0;
               }
               this.var_485 = 0;
               this.var_897 = 0;
               _loc7_ = this.var_901[this.var_404];
               for each(_loc10_ in this.var_182.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_897 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1742,this.var_1743,64,this,"window_romantic_wide");
         ...
         {
            this.var_1745 = _loc2_.id;
            this.var_1744 = _loc3_.id;

package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1451:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1171 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1861 = new Point(this.var_87.x,this.var_87.y);
         this.var_501 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1451 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1862 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1171.text = _loc5_;
         this.var_956.height = this.var_956.textHeight + 5;
         this.var_1171.y = this.var_956.y + this.var_956.height;
         this.var_1171.height = Math.max(130,this.var_1171.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_452:
                  _loc6_ = this.var_1862.clone();
                  if(this.var_501 != null)
                  {
                     this.var_501.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_501,this.var_1451,this.var_1572);
                     this.var_501.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_235:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_308,AvatarAction.const_517);
                              _loc16_.appendAction(AvatarAction.const_317,_loc8_.productClassId);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_87 != null && true)
         {
            ...
            this.var_87.x = this.var_1861.x;
            this.var_87.y = this.var_1861.y;
            if(param3 != null)
            {

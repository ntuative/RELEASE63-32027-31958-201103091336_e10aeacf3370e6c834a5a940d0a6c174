package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      private var var_691:Offer;
      
      protected var var_997:IItemGridWindow;
      
      protected var var_1572:XML;
      
      private var var_1630:Map;
      
      private var var_342:IGridItem;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         this.var_997 = _window.findChildByName("botGrid") as IItemGridWindow;
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_691,page.pageId);
      }
      
      private function onBotDefinitions(param1:RentableBotDefinitionWidgetEvent) : void
      {
         this.var_1307 = param1.botFigureData;
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         var _loc3_:String = this.var_1307.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         var _loc5_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_89,null,this);
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            this.var_1630.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = this.var_1307.getValue(this.var_691.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc1_.registerParameter(_loc5_,"credits",String(this.var_691.priceInCredits));
            _loc1_.registerParameter(_loc5_,"pixels",String(this.var_691.priceInActivityPoints));
            _loc2_.text = _loc1_.getKey(_loc5_);
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(this.var_691.localizationId);
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = this.var_1630.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = this.var_1307.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
               _loc5_ = _loc3_.productContainer.view;
               _loc6_ = _loc5_.findChildByName("image") as IBitmapWrapperWindow;
               _loc7_ = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createAvatarImage(_loc4_,AvatarScaleType.const_89,null);
               if(_loc7_)
               {
                  ...
                  _loc6_.invalidate();
                  _loc7_.dispose();
                  if(this.var_691.offerId == _loc2_)
                  {
                     this.updatePreviewImage();
                  }
               }

package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1686:String = "ctlg_";
       
      
      protected var var_2021:XML;
      ...
      private var var_1150:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1151);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1151);
      }
      ...
      {
         var _loc2_:String = const_1686 + param1;
         ...
         this.var_2021 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2021) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1625:
               if(this.var_1150 == null)
               {
                  this.var_1150 = new ItemGridCatalogWidget(param1);
                  this.var_48.push(this.var_1150);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1471:
               ...
               break;
            case CatalogWidgetEnum.const_1559:
            ...
            case CatalogWidgetEnum.const_1494:
               ...
               break;
            case CatalogWidgetEnum.const_1609:
            ...
            case CatalogWidgetEnum.const_1639:
               ...
               break;
            case CatalogWidgetEnum.const_1413:

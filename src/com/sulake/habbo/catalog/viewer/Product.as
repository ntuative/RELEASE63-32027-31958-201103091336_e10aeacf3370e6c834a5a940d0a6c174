package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1710:IProductData;
      ...
      {
         super();
         this.var_1711 = param1.productType;
         this.var_1713 = param1.furniClassId;
         this.var_1363 = param1.extraParam;
         this.var_1362 = param1.productCount;
         this.var_1712 = param1.expiration;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(this.productType)
         {
            ...
            case ProductTypeEnum.const_82:
               _loc6_ = _loc4_.getWallItemIcon(this.productClassId,param2,this.var_1363);
               break;

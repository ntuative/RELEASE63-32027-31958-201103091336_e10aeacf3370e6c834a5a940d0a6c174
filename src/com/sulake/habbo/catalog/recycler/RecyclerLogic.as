package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_911:int = 0;
      ...
      {
         return this.var_542 != const_911;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1535 != RecyclerStatusMessageEvent.const_1055;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_542 == const_410;
      }
      ...
      {
         this.var_542 = const_910;
         this.var_107 = new Array(const_191);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_191)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_542 = const_911;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1535)
         {
            case RecyclerStatusMessageEvent.const_1611:
               this.var_542 = const_410;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1055:
               if(this.var_17 == null || this.var_17.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1035:
               if(this.var_17 != null)
               {
                  this.var_17.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1592:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_107.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_191)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_107.length < const_191)
         {
            return false;
         }
         var _loc1_:int = 0;

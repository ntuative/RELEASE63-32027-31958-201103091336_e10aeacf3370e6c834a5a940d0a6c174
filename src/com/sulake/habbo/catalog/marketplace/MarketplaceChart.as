package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         this.var_637 = 0;
         for each(_loc4_ in this.var_142)
         {
         ...
         _loc3_.draw(_loc6_);
         this.var_1201 = param1 - _loc6_.textWidth - 2;
         this.var_979 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_979);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_979 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(this.var_1201 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1201,(param2 - this.var_979) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1201 + this.var_1201 / -this.var_2825 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_979 - this.var_979 / this.var_637 * this.var_142[param1];
      }
      
      public function get available() : Boolean
      {
         return this._x && this.var_142 && this._x.length > 1;
      }
   }
}

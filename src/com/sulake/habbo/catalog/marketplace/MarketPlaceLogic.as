package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1779:int = 1;
      
      public const const_1743:int = 2;
      ...
      private var var_229:MarketplaceConfirmationDialog;
      ...
      private var var_2740:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_274);
            this.var_274 = null;
         }
         if(this.var_318 != null)
         {
            this.disposeOffers(this.var_318);
            this.var_318 = null;
         }
         this._disposed = true;
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_229)
         {
            this.var_229 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_229.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2742,this.var_2741,this.var_2167,this.var_2743);
      }
      ...
      {
         if(!this.var_274 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_274.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         this.showConfirmation(this.const_1779,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_318.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_318.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_429)
            {
               this.var_318.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_274.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2418 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_318.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_274.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_274.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_274.add(parser.offerId,updateItem);
            }
            this.var_274.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_1743,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_318.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2244 || param1.furniTypeId != this.var_2243)
         {
            return;
         }

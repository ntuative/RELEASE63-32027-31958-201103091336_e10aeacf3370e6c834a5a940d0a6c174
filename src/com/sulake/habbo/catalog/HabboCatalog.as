package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_312:CatalogViewer;
      
      private var var_365:ICatalogNavigator;
      
      private var var_102:Purse;
      
      private var var_93:RecyclerLogic;
      
      private var var_130:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_229:PurchaseConfirmationDialog;
      
      private var var_311:ChargeConfirmationDialog;
      ...
      private var var_2591:GiftWrappingConfiguration;
      
      private var var_1147:ClubGiftController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_229 == null)
            {
               this.var_229 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_229.showOffer(this,param1,param2,param3,_loc4_);
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_365.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_182.getKey("client.credits.embed.enabled","FurnitureEcotronBoxLogic") == "true";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_288.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_288.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_82)
         {
            _loc3_ = this.var_288.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_753.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_102.getActivityPointsForType(Purse.const_195)));
         var _loc1_:int = 0;
      ...
      {
         this.var_185.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_150,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_720)
         {
            if(!this.var_288.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.var_185 != null && _loc2_)
         {
            this.var_185.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_312.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_365 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_312 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_312.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_254,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_88:
               this.var_1821 = param1.session.isPrivateRoom;
               if(this.var_93 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_130 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1147 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_365.buildCatalogIndex(_loc2_);
         if(this.var_752 && this.var_752 != "")
         {
            this.var_365.openPage(this.var_752);
            this.var_752 = "";
            this.var_942 = -1;
         }
         else if(this.var_942 > -1)
         {
            this.var_365.openPageById(this.var_942,this.var_1820);
            this.var_942 = -1;
            this.var_1820 = -1;
            this.var_752 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_312.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_312.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2593 && this.var_487 != null)
         {
            this.var_487.playSound(HabboSoundTypesEnum.const_1110);
         }
         this.var_2593 = false;
         if(this.var_311 != null)
         {
            this.var_311.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_65,this.var_102.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2592 && this.var_487 != null)
         {
            this.var_487.playSound(HabboSoundTypesEnum.const_1022);
         }
         this.var_2592 = false;
         if(this.var_311 != null)
         {
         ...
         if(_loc2_.type == Purse.const_195)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1147.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_312.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_130 != null)
         {
            this.var_130.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_130 != null)
         {
            this.var_130.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_130 != null)
         {
            this.var_130.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2591 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_229 != null)
         {
            this.var_229.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_130.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_311 == null)
         {
            this.var_311 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_311.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_753.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_753.add(_loc2_.productCode,_loc3_.slice());
            this.var_312.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }

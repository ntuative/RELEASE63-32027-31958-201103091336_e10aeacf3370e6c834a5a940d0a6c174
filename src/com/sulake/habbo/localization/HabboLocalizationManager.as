package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private static var var_1372:String = "%";
      ...
      private var var_1913:Dictionary;
      ...
      {
         this.var_1913 = new Dictionary();
         this.var_2687 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1914 = (param2 & 0) > 0;
         if(!this.var_1914)
         {
            lock();
         }
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1372);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1372,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1914)
            {
               if("FurnitureEcotronBoxLogic" == this.var_182.getKey("use.default.localizations","FurnitureEcotronBoxLogic"))
               {
                  _loc5_ = this.var_182.getKey("external.texts.txt","external_texts.txt");
                  events.addEventListener(LocalizationEvent.const_169,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_169,this.onLocalizationLoaded);
         if(this.var_182.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_182.getKey("external.override.texts.txt");
            events.addEventListener(LocalizationEvent.const_169,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_169,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         this.var_1913[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1913[param1];
      }
      ...
      {
         return this.var_2687[Math.max(0,param1 - 1)];
      }
   }
}

package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      public function WelcomeScreenController(param1:HabboHelp, param2:IHabboWindowManager, param3:IHabboConfigurationManager)
      {
         ...
         this._config = param3;
         this.var_124.toolbar.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
         this.var_124.toolbar.events.addEventListener(HabboToolbarEvent.const_1156,this.onToolbarResized);
         var _loc4_:Boolean = Boolean(parseInt(this._config.getKey("new.identity","0")));
         this.var_1605 = Boolean(parseInt(this._config.getKey("welcome.screen.enabled","0"))) && _loc4_;
         this.var_2195 = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this._targetLoc = new Point(72,10);
         this.var_203 = new Timer(this.var_2195,1);
         this.var_203.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
         this.var_1040 = HabboToolbarIconEnum.NAVIGATOR;
         this.var_1300 = "";
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_124)
         {
            this.var_124.toolbar.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
            this.var_124 = null;
         }
         ...
         {
            this.var_203.stop();
            this.var_203.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
            this.var_203 = null;
         }
         this._disposed = true;
      }
      ...
      public function setCategory(param1:String, param2:String = "", param3:String = "") : void
      {
         ...
         {
            this.var_1604 = "welcome.screen.title";
         }
         if(param3.length > 0)
         {
         ...
         {
            this.var_1300 = "welcome.screen.message";
         }
      }
      
      private function onTimerComplete(param1:TimerEvent) : void
      {
         var _loc2_:XmlAsset = this.var_124.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc4_:BitmapDataAsset = this.var_124.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc5_.content.setParamFlag(WindowParam.const_298,false);
         _loc5_.height -= 20;
         this._window.findChildByName("close").addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMouseClick);
         this.var_124.registerUpdateReceiver(this,10);
         this.var_1605 = false;
         this._targetLoc.y = this.var_124.toolbar.getIconLocation(this.var_1040) - this._window.height / 2;
         this._window.y = this._targetLoc.y;
         this._window.findChildByName("title").caption = "${" + this.var_1604 + "}";
         this._window.findChildByName("text").caption = "${" + this.var_1300 + "}";
         this.highlightToolbarIcon(true);
      }
      
      private function highlightToolbarIcon(param1:Boolean) : void
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_92,this.var_1040);
         _loc2_.iconState = !!param1 ? "highlight_blue" : "0";
         this.var_124.toolbar.events.dispatchEvent(_loc2_);
      }
      ...
      private function onToolbarResized(param1:HabboToolbarEvent) : void
      {
         ...
         if(this.var_124)
         {
            this.var_124.removeUpdateReceiver(this);
            this.var_124.registerUpdateReceiver(this,10);
         }
         this._targetLoc.y = this.var_124.toolbar.getIconLocation(this.var_1040) - this._window.height / 2;
      }

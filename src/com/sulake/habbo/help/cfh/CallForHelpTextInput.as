package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1324:int = 30;
      
      private static const const_1251:int = 253;
      
      private static const const_1252:int = 10;
      ...
      {
         main.showUI(HabboHelpViewEnum.const_176);
      }
      ...
      private function sendCallForHelp() : void
      {
         ...
         if(inputField.text.length < const_1324)
         {

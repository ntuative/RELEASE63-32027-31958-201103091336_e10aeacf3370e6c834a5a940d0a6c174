package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_757)
         {
            this.var_757 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_757)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_758)
         {
            this.var_758 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_758)
            {
               return;
            }

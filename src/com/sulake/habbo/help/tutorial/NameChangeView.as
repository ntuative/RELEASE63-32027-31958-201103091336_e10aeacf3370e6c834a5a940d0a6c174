package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1827:uint = 11129827;
      ...
      private var var_1152:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_274;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_495 = param1;
         if(this.var_1829 == this.var_495)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1828 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_757)
         {
            this.var_757 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_757)
            {
               return;
            }
            this._window.content.addChild(this.var_757);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_758)
         {
            this.var_758 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_758)
            {
               return;
            }
            this._window.content.addChild(this.var_758);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_758.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_495;
         }
         this.showView(this.var_758);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_495);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_996:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_995:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_995 || param1 == ChangeUserNameResultMessageEvent.var_996)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1152 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1152.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_1443)
         {
            if(param1.type == WindowEvent.const_105)
            {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_495 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_495);
               break;

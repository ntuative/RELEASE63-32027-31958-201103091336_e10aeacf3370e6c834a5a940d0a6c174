package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_274:String = "TUI_NAME_VIEW";
      
      public static const const_404:String = "TUI_CLOTHES_VIEW";
      
      public static const const_548:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_361:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_426,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_562,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_577,this.onTaskDoneEvent);
         if(this.var_35.sessionDataManager != null)
         {
            this.var_35.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_326,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1141 && this.var_1142 && this.var_1426;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_426,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_562,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_577,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
               this.var_35.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_326,this.onFigureUpdate);
            }
            this.var_35 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_426:
               this.var_1426 = true;
               if(this.var_44 != null && this.var_44.id == const_548)
               {
                  this.showView(const_93);
               }
               break;
            case HabboHelpTutorialEvent.const_562:
               if(this.var_44 != null && this.var_44.id == const_404)
               {
                  this.var_1806 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2483 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_274:
               ...
               if(this.var_361 == null)
               {
                  this.var_361 = new NameChangeView(this);
               }
               this.var_361.showMainView();
               this.prepareForTutorial();
               break;
            case const_404:
         ...
         this._window.height = _loc2_.height + this.var_2485;
         this._window.width = _loc2_.width + this.var_2483;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_44 != null && (this.var_44.id == const_274 || this.var_44.id == const_93))
         {
            this.showView(const_93);
         }
      }
      ...
      {
         this.var_1141 = true;
         if(this.var_44 != null && (this.var_44.id == const_404 || this.var_44.id == const_93))
         {
            this.showView(const_93);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_361.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_530)
         {
            this.var_361.checkedName = _loc2_.name;
         }
         else
         {
            this.var_361.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);

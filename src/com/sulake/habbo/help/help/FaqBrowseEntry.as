package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(param1 != null)
         {
            this.var_210 = FaqItem(param1);
         }
         if(this.var_210 == null)
         {
            return;
         }
         if(!this.var_210.hasAnswer)
         {
            main.sendMessage(new GetFaqTextMessageComposer(this.var_210.method_1));
            return;
         }
         var _loc3_:FaqCategory = this.var_210.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = this.var_210.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = this.hackHTML(this.var_210.answerText);
         }
         if(_loc3_ != null)
         {
            _loc5_ = _loc3_.getItemByIndex(this.var_210.index + 1);
         }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_210 != null)
         {
            _loc2_ = this.var_210.category;
            main.showUI(HabboHelpViewEnum.const_275);
            main.tellUI(HabboHelpViewEnum.const_275,_loc2_);
         }
      }
      ...
      private function getNextItem() : FaqItem
      {
         ...
         if(_loc1_ == null || this.var_210 == null)
         {
            return null;
         }
         var _loc2_:FaqCategory = this.var_210.category;
         if(_loc2_ == null)
         {
            return null;
         }
         return _loc2_.getItemByIndex(this.var_210.index + 1);
      }
   }
}

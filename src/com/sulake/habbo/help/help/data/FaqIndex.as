package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_766:FaqCategory;
      
      private var var_768:FaqCategory;
      
      private var var_767:FaqCategory;
      ...
      {
         super();
         this.var_766 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_768 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_767 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_766.hasItem(param1))
         {
            this.var_766.getItem(param1).answerText = param2;
         }
         if(this.var_768.hasItem(param1))
         {
            this.var_768.getItem(param1).answerText = param2;
         }
         if(this.var_767.hasItem(param1))
         {
            this.var_767.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_766.hasItem(param1))
         {
            return this.var_766.getItem(param1);
         }
         if(this.var_768.hasItem(param1))
         {
            return this.var_768.getItem(param1);
         }
         if(this.var_767.hasItem(param1))
         {
            return this.var_767.getItem(param1);
         }
         var _loc2_:int = 0;

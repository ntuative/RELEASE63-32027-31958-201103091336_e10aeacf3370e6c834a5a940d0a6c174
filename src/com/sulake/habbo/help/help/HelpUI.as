package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103091331));
         this.var_185 = param5;
         this.var_112 = new Map();
         this.var_112.add(HabboHelpViewEnum.const_1442,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_176,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_465,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_275,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_271,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_392,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_863,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_242,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_112.add(HabboHelpViewEnum.const_998,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_112.add(HabboHelpViewEnum.const_1121,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_664,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_486.length == 0 || param1 != this.var_350)
            {
               this.var_486.push(this.var_350);
            }
         }
         this.var_350 = param1;
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_185.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_112.getValue(HabboHelpViewEnum.const_176) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_426));
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2483 = this._window.width - _loc4_.width;
         this.var_2485 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2485;
         this._window.width = _loc1_.width + this.var_2483;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_486.pop(),false);
         }
      }
      ...
      private function method_4(param1:Boolean = false) : void
      {
         var _loc3_:* = null;
         if(this.var_350 == HabboHelpViewEnum.const_176)
         {
            return;
         }
         if(this.var_595.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_595.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_595[1],this.var_595[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_595[0],this.var_595[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_350 == HabboHelpViewEnum.const_176 || this.var_486.length == 0)
         {
            return;
         }
         if(this.var_349 == null)
         {
            ...
            this.var_349 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_349.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_349.findChildByName("back_text");
            if(_loc5_ != null)
            {

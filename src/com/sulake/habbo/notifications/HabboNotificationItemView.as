package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_477:int = 4;
      
      private static const name_2:int = 0;
      
      private static const const_552:int = 1;
      
      private static const const_954:int = 2;
      
      private static const const_955:int = 3;
      
      private static const const_417:Number = 50;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1842 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1842 = 15;
         }
         this.var_1843 = this._window.height;
         this.var_762 = 4;
         this.var_763 = 0;
         this._state = name_2;
         this.var_185 = param5;
      ...
      {
         if(param1.badgeId != this.var_210.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_552:
               ...
               _loc2_ = Number(this.var_1163) / Number(this.var_425["time_fade_in"]);
               if(this.var_1163 > int(this.var_425["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_954:
               ...
               if(this.var_1446 > int(this.var_425["time_display"]) && !this.var_1841)
               {
                  this.startFadeOut();
               }
               break;
            case const_955:
               ...
               _loc3_ = 1 - Number(this.var_1162) / Number(this.var_425["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1162 > int(this.var_425["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         if(this._window.height < this.var_1843)
         {
            this._window.height = this.var_1843;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_185.orientation == "TOP" ? int(const_417) : 0;
         var _loc4_:int = this.var_185.orientation == "BOTTOM" ? int(_loc2_.height - const_417) : int(_loc2_.height);
         var _loc5_:int = this.var_185.orientation == "LEFT" ? int(const_417) : 0;
         var _loc6_:int = this.var_185.orientation == "RIGHT" ? int(_loc2_.width - const_417) : int(_loc2_.width);
         if(this.var_425["position_horizontal_follow_toolbar"] == "true" && (this.var_185.orientation != "TOP" && this.var_185.orientation != "BOTTOM"))
         {
            if(this.var_185.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_477;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_477;
            }
         }
         else if(this.var_425["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_477;
         }
         else
         ...
         if(this.var_425["position_vertical_follow_toolbar"] == "true" && (this.var_185.orientation != "RIGHT" && this.var_185.orientation != "LEFT"))
         {
            if(this.var_185.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_762;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_762;
            }
         }
         else if(this.var_425["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_762;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_763;
      }
   }
}

package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1694:String = "badge_bg_001_png";
      
      private const const_1976:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1282 = param7;
         this.var_2114 = param5;
         this.var_1561 = param6;
         this.var_76 = param10;
         this._assets = param8;
         this.var_288 = param13;
         ...
         this._window.center();
         this.var_2115 = this.var_76.getBadgeName(this.var_284);
         this.var_2118 = this.var_76.getBadgeDesc(this.var_284);
         this.var_2117 = this.var_76.getAchievementNameForFacebook(this.var_284,this.var_288.userName,this.var_288.realName,this.var_1283);
         this.var_2119 = this.var_76.getAchievementDescForFacebook(this.var_284,this.var_288.userName,this.var_288.realName,this.var_1283);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2116 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_76.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1558.toString());
         this.var_76.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1282.toString());
         this.var_76.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1282.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1561;
         var _loc17_:String = this.var_1561 == 0 ? "pixels" : "activitypoints";
         this.var_76.registerParameter(_loc16_,_loc17_,"" + this.var_2114);
         _loc15_.caption = this.var_76.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1694);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1976) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1282 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_284,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_284,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_284,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_76.registerParameter(param1,"badge_name",this.var_2115);
         this.var_76.registerParameter(param1,"badge_desc",this.var_2118);
         this.var_76.registerParameter(param1,"badge_name_fb",this.var_2117);
         this.var_76.registerParameter(param1,"badge_desc_fb",this.var_2119);
         this.var_76.registerParameter(param1,"level",this.var_1283.toString());
         this.var_76.registerParameter(param1,"name",this.var_288.userName);
         return this.var_76.registerParameter(param1,"realname",this.var_288.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_288.events.removeEventListener(BadgeImageReadyEvent.const_142,this.onBadgeImageReady);
            this.var_288 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_284)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1694);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_284,this._feedTitleFb,this.var_2116,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2113));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_284,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_284,"client.skip_post"));
               this.dispose();
               return;
         }
      }

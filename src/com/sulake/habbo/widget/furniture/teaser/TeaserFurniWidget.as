package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1725:int = 1;
      
      private const const_1726:int = 2;
      
      private const const_1724:int = 3;
      
      private const const_1722:int = 4;
      
      private const const_2021:int = 0;
      
      private const const_2025:int = 1;
      
      private const const_2019:int = 2;
      
      private const const_2017:int = 3;
      
      private const const_2023:int = 4;
      
      private const const_2018:int = 5;
      
      private const const_1727:String = "deco_img";
      
      private const const_1721:String = "dialog_bg";
      
      private const const_2022:String = "%campaign%_dialog_bg.png";
      
      private const const_330:String = "%campaign%_gift_package.png";
      
      private const const_2020:String = "%campaign%_gift_content.png";
      
      private const const_2024:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1437 = this.var_149.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1437 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1438.length)
         {
            _loc2_ = this.var_1438.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_149 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_569,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_810,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_569,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_569:
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_709:
               ...
               this._shareId = null;
               this.var_1435 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_810:
               _loc2_ = this.const_1725;
               this.var_367 = param1.objectId;
               this._shareId = param1.data;
               this.var_385 = param1.status;
               this.var_1435 = param1.itemCategory;
               var_76.registerParameter("notifications.viral_furni.fb.title","realname",param1.method_3);
               var_76.registerParameter("notifications.viral_furni.fb.desc","realname",param1.method_3);
         ...
         if(this._window && (this.var_1436 != _loc2_ || _loc3_ != this.var_181))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_181 = _loc3_;
         this.var_1436 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1436)
            {
               ...
               case this.const_1725:
                  ...
                  else if(this.var_385 == this.const_2018)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_181,"client.show.campaign_closed");
            ...
            _loc5_ = this.const_2022.replace("%campaign%",this.var_181);
            this.setDecoImage(_loc5_,this.const_1721);
            _loc2_ = _loc2_.replace("%campaign%",this.var_181);
            this.setDecoImage(_loc2_,this.const_1727);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_813);
      ...
      {
         this.sendConversionPoint("viral_" + this.var_181,"client.skip_post");
         this.hideInterface();
      }
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         this.sendConversionPoint("viral_" + this.var_181,"client.start_post",this._shareId);
         var _loc4_:String = this.var_149.getKey("viral.furni.post_type","feed");
         HabboWebTools.facebookViralGiftPost(this.var_181,_loc2_,_loc3_,this._shareId,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1435 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1435 == 1 ? "null" : InventoryCategory.const_147);
            }
         }
         this.sendConversionPoint("viral_" + this.var_181,"client.open_gift");
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_650,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1438.push(new ImageDownloader(this,_assets,this.var_181,this.var_1437,param1,param2));
            return;
         }
      ...
      function onDecoImageReady(param1:ImageDownloader) : void
      {
         ...
         if(!this._window || this.var_181 != param1.campaignID)
         {
            return;
         }

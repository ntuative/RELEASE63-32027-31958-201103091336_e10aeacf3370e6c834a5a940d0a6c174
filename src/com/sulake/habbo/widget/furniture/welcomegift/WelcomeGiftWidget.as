package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_920:String = "welcome_gift_email_unverified";
      
      private const const_1696:String = "welcome_gift_email_verified";
      
      private const const_1259:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1290)
         {
            this.setViewState(this.const_1696);
         }
         else
         {
            this.setViewState(this.const_920);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_920:
               ...
               this.var_17.findChildByName("email").caption = this.var_1034;
               break;
            case this.const_1259:
      ...
      {
         this.setViewState(this.const_1259);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_736,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1290 ? this.const_1696 : this.const_920);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1034 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1034));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_117,this.updateEventHandler);
         param1.addEventListener(RoomWidgetEmailUpdateEvent.const_540,this.emailChangeHandler);
         param1.addEventListener(RoomWidgetEmailUpdateEvent.const_508,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_117,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetEmailUpdateEvent.const_540,this.emailChangeHandler);
         param1.removeEventListener(RoomWidgetEmailUpdateEvent.const_508,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_117:
               this.var_1034 = param1.email;
               this.var_1290 = param1.isVerified;
               this.var_2220 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetEmailUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetEmailUpdateEvent.const_540:
               this.setViewState(this.const_920);
               break;
            case RoomWidgetEmailUpdateEvent.const_508:

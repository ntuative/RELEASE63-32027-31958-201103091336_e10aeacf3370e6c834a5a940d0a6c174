package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1331:int = 11;
      
      private static const const_602:int = 18;
      
      private static const const_948:int = 16;
      
      private static const const_1332:int = 20;
      ...
      private var var_308:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_2513 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_352 = new Timer(1000,1);
         this.var_352.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_352.reset();
            this.var_352.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_352 = null;
         }
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_198,this.windowKeyEventProcessor);
         _loc6_.addEventListener(WindowEvent.const_105,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_403,this.onWindowMoved);
         this.var_1771 = true;
         this.var_488 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_602 + const_948;
         _loc1_.x = const_602;
         _loc1_.y = const_1331;
      }
      ...
      {
         this.var_308 = param1 - (const_602 + const_948);
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1332);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_488.length + 1)
            {
               _loc2_.text = "";
            }
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_308)
         {

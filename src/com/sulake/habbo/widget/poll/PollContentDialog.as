package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1066;
         if(this.var_1066 < this.var_855.length)
         {
            _loc1_ = this.var_855[this.var_1066] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function method_5() : void
      {
         ...
         if(!this.var_392)
         {
            ...
            this.var_392 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_392.center();
            this.var_392.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_855[this.var_1066] as Dictionary;
         ...
         message.method_1 = question["id"] as int;

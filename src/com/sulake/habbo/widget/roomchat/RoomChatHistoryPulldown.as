package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_955:int = 3;
      ...
      private static const const_982:int = 150;
      
      private static const const_983:int = 250;
      ...
      private var var_2754:BitmapData;
      ...
      private var var_2757:BitmapData;
      
      private var var_2755:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_39 = param3;
         this.var_2754 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1954 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2752 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1955 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1953 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2753 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2757 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_78 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_290,HabboWindowStyle.const_31,HabboWindowParam.const_61,new Rectangle(0,0,param3.width,param3.height - const_84),null,0,0) as IBitmapWrapperWindow;
         this.var_39.addChild(this.var_78);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_62,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,this.var_39.height - const_84,param3.width,const_84),null,0) as IWindowContainer;
         this.var_39.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_579,HabboWindowStyle.const_42,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_84),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_552:
               this.var_78.blend += param1 / const_983;
               this._window.blend += param1 / const_983;
               ...
               break;
            case const_955:
               this.var_78.blend -= param1 / const_982;
               this._window.blend -= param1 / const_982;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_39.height - const_84;
            this._window.width = this.var_39.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_39.height - const_84;
            this._region.width = this.var_39.width - this.var_2755;
         }
         if(this.var_78 != null)
         {
            this.var_78.rectangle = this.var_39.rectangle;
            this.var_78.height -= const_84;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2756 == this._window.width)
         {
            return;
         }
         this.var_2756 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2752;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1955;
            _loc2_.disposesBitmap = false;
            this.var_2755 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2754,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1954,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1954,_loc9_);
         ...
         this.var_78.bitmap = this.var_2757;

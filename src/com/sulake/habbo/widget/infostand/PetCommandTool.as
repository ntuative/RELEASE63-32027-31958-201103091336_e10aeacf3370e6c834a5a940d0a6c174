package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_390:IFrameWindow;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_332 = new Timer(this.const_1977);
         this.var_332.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1027.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_462);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1027.getValue(this.var_462) as CommandConfiguration;
      ...
      {
         this.var_1027.remove(param1);
         this.var_1027.add(param1,param2);
         if(param1 != this.var_462)
         {
            return;
         }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_632,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_40.setParamFlag(WindowParam.const_101,true);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_390 == null)
         {
            ...
            this.var_390 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_390 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_390.x = 200;
            this.var_390.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_348,this.var_462));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_572,this.var_462,this.var_1565 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_572,this.var_462,this.var_1565 + " " + _loc5_);

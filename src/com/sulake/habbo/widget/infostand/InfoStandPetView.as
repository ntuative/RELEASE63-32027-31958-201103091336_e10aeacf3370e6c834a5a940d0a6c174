package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1988:int = 152;
      
      private const const_1996:int = 16;
      
      private const const_1277:int = 4;
      
      private const const_1995:uint = 14342874;
      
      private const const_1989:uint = 3815994;
      
      private const const_1990:uint = 2085362;
      
      private const const_1991:uint = 39616;
      
      private const const_1994:uint = 10513106;
      
      private const const_1997:uint = 8734654;
      
      private const const_1992:uint = 9094430;
      
      private const const_1985:uint = 6200576;
      
      private const const_1986:String = "happiness";
      
      private const const_1993:String = "experience";
      ...
      private function updateWindow() : void
      {
         ...
         this.var_67.visible = this.var_67.width > 0;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1986,param1.nutrition,param1.nutritionMax,this.const_1991,this.const_1990);
         this.updateStateElement(this.const_1993,param1.experience,param1.experienceMax,this.const_1997,this.const_1994);
         this.updateStateElement(this.const_1987,param1.energy,param1.energyMax,this.const_1985,this.const_1992);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_1988,this.const_1996,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_1995);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_1989);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1277,_loc7_.width - 2,_loc7_.height - 2 - this.const_1277);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1277);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_462) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            _loc12_ = this.var_67.getListItemAt(_loc4_) as IRegionWindow;
            if(_loc12_ != null)
            {
         ...
         var _loc10_:* = [];
         this.var_67.groupListItemsWithTag("CMD_BUTTON",_loc10_,true);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_193 && this.var_193.getPetId() == this.var_462)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1445,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_581,this._widget.petData.ownerId);
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IRegionWindow = this.var_67.getListItemByName("petrespect") as IRegionWindow;
         if(_loc1_ == null)
         {
            return;
         }

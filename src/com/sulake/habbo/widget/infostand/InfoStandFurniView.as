package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_817 = this.var_192.findChildByTag("catalog");
         if(this.var_817 != null)
         {
            this.var_817.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         this.var_67.visible = _loc2_ || _loc3_ || _loc4_;
         this.updateWindow();
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_53.addListItem(this.var_817);
            }
            this.var_817.visible = param1;
         }
         else
         {
            this.var_53.removeListItem(this.var_817);
         }
      }
   }
}

package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_67:IItemListWindow;
      
      private var var_162:IFrameWindow;
      
      private var var_639:IWindow;
      
      private var var_192:IBorderWindow;
      
      private var var_1085:TagListRenderer;
      
      private var var_134:IBorderWindow;
      
      private var var_2695:int;
      
      private const const_972:int = 5;
      
      private const const_1735:int = 39;
      
      private const const_1734:int = 7829367;
      
      private const const_1733:int = 16777215;
      
      private const const_2027:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1085 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_53 == null || this.var_192 == null || this.var_67 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_192.width,this.var_67.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_192.width < this.var_67.width)
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:* = [];
         this.var_67.groupListItemsWithTag("CMD_BUTTON",_loc3_,true);
         ...
         {
            _loc7_ = 0;
            while(_loc7_ < this.var_67.numListItems)
            {
               _loc12_ = this.var_67.getListItemAt(_loc7_) as IRegionWindow;
               if(_loc12_ != null)
               {
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_972;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1734;
            }
            else
            {
               _loc3_.textColor = this.const_1733;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_972;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_342,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_342,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1085.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_67.getListItemByName(param1) as IRegionWindow;
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = this.var_67.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1133:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1096:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2695 > this.const_2027 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2695 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1734;
            if(_loc3_.length >= this.const_1735)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1735 - 1);
            }
         }
      }
      ...
      {
         this.var_162 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_162.center();
         this.var_162.procedure = this.badgesEventProc;
         this.var_162.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_162 && this.var_162.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_639 = null;
         var _loc2_:IItemGridWindow = this.var_162.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_162.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_162.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_639);
               }
               if(_loc3_ <= -1)
               {
                  return;

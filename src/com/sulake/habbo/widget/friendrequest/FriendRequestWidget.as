package com.sulake.habbo.widget.friendrequest
{
   ...
   public class FriendRequestWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_448,this.eventHandler);
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_507,this.eventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_448,this.eventHandler);
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_507,this.eventHandler);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         for each(_loc2_ in this._requests)
         {
            if(_loc2_)
            {
               _loc3_ = messageListener.processWidgetMessage(new RoomWidgetGetUserLocationMessage(_loc2_.userId,RoomObjectTypeEnum.const_178)) as RoomWidgetUserLocationUpdateEvent;
               if(_loc3_)
               {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetFriendRequestMessage(RoomWidgetFriendRequestMessage.const_792,param1));
         this.removeRequest(param1);
      }

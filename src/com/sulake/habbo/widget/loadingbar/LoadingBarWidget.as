package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_526:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_526.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_526 = null;
         }
         if(this.var_45 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_285,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_285,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_526 == null)
         {
            this.var_526 = new Sprite();
            this.var_526.addChild(new Bitmap(this.var_45));
            this.var_526.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_526.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_45;
            }
         }
         _loc2_.setDisplayObject(this.var_526);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_285)
         {
            return;
         }
         if(this._window != null)

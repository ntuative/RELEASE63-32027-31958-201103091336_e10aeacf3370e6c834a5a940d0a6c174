package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1397:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","FurnitureEcotronBoxLogic") == "true")
         {
            this.var_1397 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this.var_17 == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_150,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1029,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_125,this.onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_92,this.onSetToolbarIconStateEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_1007,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1046,this.onHideWindowEvent);
         this._state = true;

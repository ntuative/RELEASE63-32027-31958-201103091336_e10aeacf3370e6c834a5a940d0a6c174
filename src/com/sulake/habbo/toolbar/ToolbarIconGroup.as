package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_630:ToolbarBarMenuAnimator;
      ...
      {
         return this.var_1296.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2170.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_679.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      {
         return this.var_679.indexOf(param1) > -1;
      }
      ...
      public function get size() : Number
      {
         ...
         {
            if(this.var_286[_loc2_].exists)
            {
               _loc1_ += this.var_1298;
            }
            _loc2_++;
         }
         return _loc1_;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1297.length)
         {
            _loc2_ = this.var_679.indexOf(this.var_1297[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_286[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1134 + _loc3_);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_286[this.var_679.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_630);
         this.var_39.addChild(_loc2_.window);
         this.var_679.push(param1);
         this.var_286.push(_loc2_);
         return _loc2_;
      }
   }
}

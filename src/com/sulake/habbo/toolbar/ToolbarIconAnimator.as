package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      private var var_2812:Number;
      
      private var var_2811:Number;
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1748 = param1.nextState;
         this.var_1415 = param1.loop;
         if(param1.background != null)
         {
            this.var_740 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_923.push(new XML());
               this.var_922.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_922[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1415 == true || this.var_921 == 0)
         {
            if(this.var_923.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_923.length)
               {
                  this._frame = 0;
                  ++this.var_921;
               }
      ...
      {
         return this.var_923.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1415 == false && this.var_921 == 1 && this.var_1748 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_922.length)
         {
            _loc2_ = this.var_922[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_740.width),Math.max(param2.height,this.var_740.height),true,0);
            _loc4_ = _loc3_.height - this.var_740.rect.height;
            _loc3_.copyPixels(this.var_740,this.var_740.rect,new Point(0,_loc4_),null,null,true);

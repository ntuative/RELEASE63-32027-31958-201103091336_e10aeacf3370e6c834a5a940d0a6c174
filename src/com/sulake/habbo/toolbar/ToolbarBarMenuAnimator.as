package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_206:Boolean = true;
      
      private static const const_1247:Number = 25;
      
      private static const const_1244:Number = 90;
      
      private static const const_952:int = 50;
      
      private static const const_1337:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1411:ToolbarView;
      
      private var var_739:Timer;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_739 = new Timer(const_1247);
         this.var_739.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_357[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_952 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_952 || param1.desktop.height - param1.y < const_1337;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            this.var_357.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_603[this.var_602.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_602[this.var_603.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_602.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_602.splice(_loc3_,1);
            this.var_603.splice(_loc3_,1);
         }
         this.var_603.push(param1.name);
         this.var_602.push(param2);
         param1.addEventListener(WindowEvent.const_403,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_229,this.windowEventListener);
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_357.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_357.splice(this.var_357.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_603.length)
         {
            if(this.var_603[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_602[_loc2_];
               if(this.var_604[_loc3_] != null)
               {
                  _loc4_ = 0;
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_357.length)
         {
            _loc2_ = this._itemList[this.var_357[_loc7_]];
            if(_loc2_.active)
            {

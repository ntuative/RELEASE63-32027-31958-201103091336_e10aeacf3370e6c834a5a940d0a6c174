package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_469:String = "LEFT";
      ...
      private var var_1309:Number = 0;
      
      private var var_1633:Number = 15;
      
      private var var_1634:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_215 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_62,HabboWindowStyle.const_1091,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1054 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1054)
         {
         ...
         this.var_1053 = _loc6_.toolbar.@margin_top;
         this.var_1309 = _loc6_.toolbar.@margin_bottom;
         this.var_1633 = _loc6_.toolbar.@min_group_margin;
         this.var_1634 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_315 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_241,param1,param2,this._window,this.var_315);
         this.createGroupsFromXmlList(_loc8_,this.var_563,param1,param2,this.var_215,this.var_315);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_145,this.var_469,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_469);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_145,this.var_469);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_145,this.var_469);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_1156);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_563.length)
         {
            _loc2_ = this.var_563[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_215.x = this.var_145 + this.var_1634;
               this.var_215.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_215.x = 0;
               this.var_215.y = this.var_145 + this.var_1634;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1053;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_241.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1633,(this._window.height - _loc5_ * _loc8_ - this.var_1053 - this.var_1309) / (this.var_241.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1633,(this._window.width - _loc5_ * _loc8_ - this.var_1053 - this.var_1309) / (this.var_241.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_241.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_469;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1054 && this.var_1310)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_469)
            {
               this.var_469 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_491);
                  _loc3_.orientation = this.var_469;

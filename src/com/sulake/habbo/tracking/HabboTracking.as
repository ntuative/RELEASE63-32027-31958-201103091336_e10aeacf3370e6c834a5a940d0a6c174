package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_973:uint = 11;
      ...
      private var var_1205:IHabboWindowManager;
      
      private var var_185:IHabboToolbar;
      
      private var var_124:IHabboHelp;
      ...
      private var var_640:FramerateTracker = null;
      
      private var var_271:LatencyTracker = null;
      
      private var var_642:LagWarningLogger = null;
      
      private var var_641:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_640 = new FramerateTracker();
         this.var_271 = new LatencyTracker();
         this.var_642 = new LagWarningLogger();
         this.var_641 = new ToolbarClickTracker(this);
         this.var_1484 = new Array(const_973);
         var _loc4_:int = 0;
         while(_loc4_ < const_973)
         {
            this.var_1484[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1647,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1452,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1480,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_861,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1228,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1205)
            {
               this.var_1205.release(new IIDHabboWindowManager());
               this.var_1205 = null;
            }
            if(this.var_304)
            {
            ...
            if(this.var_204)
            {
               if(!this.var_204.disposed)
               {
                  ...
                  Component(this.var_204).events.removeEventListener(HabboFriendListTrackingEvent.const_393,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_124)
            {
               if(!this.var_124.disposed)
               {
                  this.var_124.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_124.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_124.release(new IIDHabboHelp());
               this.var_124 = null;
            }
            if(this.var_185)
            {
               ...
               {
                  this.var_185.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_182)
         {
            if(this.var_271 != null)
            {
               this.var_271.configuration = this.var_182;
            }
            if(this.var_272 != null)
            {
               this.var_272.configuration = this.var_182;
            }
            ...
            if(this.var_182)
            {
               ...
               {
                  this.var_642.configure(this.var_182);
               }
               if(this.var_640 != null)
               {
                  this.var_640.configure(this.var_182);
               }
               if(this.var_641 != null)
               {
                  this.var_641.configure(this.var_182);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_169);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_886,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_738,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_68,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_551,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_642 != null)
            {
               this.var_642.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_738)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1447);
         }
         else if(param1.type == HabboHotelViewEvent.const_551)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1674);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1441);
               break;
            case HabboCommunicationEvent.const_886:
               this.trackLoginStep(HabboLoginTrackingStep.const_1558,String(this._communication.port));
               break;
      ...
      {
         this.var_1205 = IHabboWindowManager(param2);
         if(this.var_1205)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_182)
            {
               if(this.var_182.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1484)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1140);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1140,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_204).events.addEventListener(HabboFriendListTrackingEvent.const_393,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_393:
      ...
      {
         this.var_124 = param2 as IHabboHelp;
         this.var_124.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_124.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1228,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_861,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_295,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_304 = param2 as IAdManager;
         this.var_304.events.addEventListener(AdEvent.const_463,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_185 = param2 as IHabboToolbar;
         this.var_185.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_641)
         {
            this.var_641.track(param1.iconName);
         }
      }
      ...
      {
         this.var_642.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1920;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1920);
         }
         if(this.var_525 > -1 && _loc2_ - this.var_525 > 15000)
         {
            ++this.var_1919;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1919);
         }
         this.var_525 = _loc2_;
         if(this.var_272 != null)
         {
         ...
         if(this.var_271 != null)
         {
            this.var_271.update(param1,this.var_525);
         }
         if(this.var_640 != null)
         {
            this.var_640.trackUpdate(param1,this,this.var_525);
         }
         if(this.var_642 != null)
         {
            this.var_642.update(this.var_525);
         }
      }
   }
}

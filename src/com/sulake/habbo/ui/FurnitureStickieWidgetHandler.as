package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_844,RoomWidgetStickieSendUpdateMessage.const_834,RoomWidgetStickieSendUpdateMessage.const_583];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_844:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_1231);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
            ...
            case RoomWidgetStickieSendUpdateMessage.const_583:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_834:

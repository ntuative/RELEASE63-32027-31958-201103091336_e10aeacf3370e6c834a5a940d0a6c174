   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_326,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_682,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_634,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_185 != null)
            {
               this.var_185.events.removeEventListener(HabboToolbarEvent.const_73,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_424,this.onHelpTutorialEvent);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_326,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_682,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_634,this.onHabboClubSubscriptionChanged);
         }
         this.var_185 = this._container.toolbar;
         if(this.var_185 != null)
         {
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_424,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1399)
            {
               ...
               this.var_1399 = _loc2_;
               this.var_1764 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1764;
            }
         }
         if(this.var_185 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1029,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_185.events.dispatchEvent(_loc5_);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_850);
         _loc1_.push(RoomWidgetDanceMessage.const_654);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_781);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_804);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_772);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_891);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_652);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_396);
         _loc1_.push(RoomWidgetStopEffectMessage.const_857);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1673);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1130);
         _loc1_.push(RoomWidgetToolbarMessage.const_907);
         _loc1_.push(RoomWidgetToolbarMessage.const_805);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_364);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1490);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1141);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_869);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_763);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_665);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1446);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_867);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_668);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_820);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_400);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_763:
               ...
               break;
            case RoomWidgetWaveMessage.const_850:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_654:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_781:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_804:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_772:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_396:
               ...
               break;
            case RoomWidgetOpenInventoryMessage.const_652:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1034:
                        this._catalog.openCatalogPage(CatalogPageName.const_1633,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1032:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1425:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1622:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_891:
            case RoomWidgetStopEffectMessage.const_857:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1130:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_869:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_907:
               ...
               if(this.var_185)
               {
                  this.var_185.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_805:
               ...
               {
                  this.var_185.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_547,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_364:
            ...
            case RoomWidgetGetSettingsMessage.const_665:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_867:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_402,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_668:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_402,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_820:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_577));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_400:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_835));
               break;
            default:

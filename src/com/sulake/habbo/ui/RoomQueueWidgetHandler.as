package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_746);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_662);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1057);
               break;
            case RoomWidgetRoomQueueMessage.const_746:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1166);
               break;
            case RoomWidgetRoomQueueMessage.const_662:
               if(this._container.catalog != null)
               {
                  this._container.catalog.openCatalogPage(CatalogPageName.const_201,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_444];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_444:
               ...
               {
                  case RoomSessionQueueEvent.const_1166:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_1057:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc5_.length > 1)
               {
                  if(_loc4_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_990) != -1)
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_990) + 1;
                     _loc7_ = true;
                  }
                  else
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1419) + 1;
                  }
               }
               else
               {

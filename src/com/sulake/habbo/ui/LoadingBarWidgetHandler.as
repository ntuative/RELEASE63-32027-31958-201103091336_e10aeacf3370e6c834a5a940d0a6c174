package com.sulake.habbo.ui
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_561;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(AdEvent.const_506);
         _loc1_.push(AdEvent.const_484);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_104);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_285);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_104:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_285:
               this._container.events.dispatchEvent(param1);
         }
      }

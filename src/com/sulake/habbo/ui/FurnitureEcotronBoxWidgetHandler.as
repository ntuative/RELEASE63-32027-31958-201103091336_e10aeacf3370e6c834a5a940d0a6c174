package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_625,RoomWidgetEcotronBoxOpenMessage.const_640,RoomWidgetEcotronBoxOpenedMessage.const_1650];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_625:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_640:

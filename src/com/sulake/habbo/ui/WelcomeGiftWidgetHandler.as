package com.sulake.habbo.ui
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetChangeEmailMessage.const_892);
         return _loc1_;
      }
      
      public function getProcessedEvents() : Array
      {
         return [RoomSessionWelcomeGiftEvent.const_117];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniActionMessage.const_736:
               ...
               break;
            case RoomWidgetChangeEmailMessage.const_892:
               _loc3_ = Math.random() > 0.5 ? "null" : RoomWidgetEmailUpdateEvent.const_508;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionWelcomeGiftEvent.const_117:

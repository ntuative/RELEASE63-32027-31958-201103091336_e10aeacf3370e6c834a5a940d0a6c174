   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_165,this.onFigureUpdate);
         ...
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_165,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_618.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_618.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_384);
         _loc1_.push(RoomWidgetUserActionMessage.const_884);
         _loc1_.push(RoomWidgetUserActionMessage.const_666);
         _loc1_.push(RoomWidgetUserActionMessage.const_868);
         _loc1_.push(RoomWidgetUserActionMessage.const_819);
         _loc1_.push(RoomWidgetUserActionMessage.const_870);
         _loc1_.push(RoomWidgetUserActionMessage.const_581);
         _loc1_.push(RoomWidgetUserActionMessage.const_635);
         _loc1_.push(RoomWidgetUserActionMessage.const_832);
         _loc1_.push(RoomWidgetUserActionMessage.const_796);
         _loc1_.push(RoomWidgetUserActionMessage.const_697);
         _loc1_.push(RoomWidgetUserActionMessage.const_695);
         _loc1_.push(RoomWidgetGiveBadgeMessage.GIVE_BADGE);
         _loc1_.push(RoomWidgetFurniActionMessage.const_252);
         ...
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_881);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_724);
         _loc1_.push(RoomWidgetUserActionMessage.const_471);
         _loc1_.push(RoomWidgetUserActionMessage.const_849);
         _loc1_.push(RoomWidgetUserActionMessage.const_585);
         _loc1_.push(RoomWidgetUserActionMessage.const_1669);
         _loc1_.push(RoomWidgetPetCommandMessage.const_572);
         _loc1_.push(RoomWidgetPetCommandMessage.const_632);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_471)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_348 || param1.type == RoomWidgetUserActionMessage.const_431 || param1.type == RoomWidgetUserActionMessage.const_585)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_384:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetUserActionMessage.const_884:
            ...
            case RoomWidgetUserActionMessage.const_431:
               ...
               break;
            case RoomWidgetUserActionMessage.const_868:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_992,_loc3_.name);
               this._container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_819:
               this._container.sessionDataManager.ignoreUser(_loc3_.name);
               break;
            case RoomWidgetUserActionMessage.const_870:
            ...
            case RoomWidgetUserActionMessage.const_635:
               ...
               break;
            case RoomWidgetUserActionMessage.const_832:
            ...
            case RoomWidgetUserActionMessage.const_796:
               ...
               break;
            case RoomWidgetUserActionMessage.const_697:
            ...
            case RoomWidgetFurniActionMessage.const_696:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_252:
            ...
            case RoomWidgetRoomTagSearchMessage.const_653:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_881:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_724:
            ...
            case RoomWidgetUserActionMessage.const_471:
               ...
               break;
            case RoomWidgetUserActionMessage.const_849:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_632:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_303);
               _loc6_.id = param1.id;
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_385);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1142);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1116);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_187)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_178)
               {
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_439);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_111)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_141)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_691);
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1133;
                  }
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1096;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1487);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_618.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_618.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_691);

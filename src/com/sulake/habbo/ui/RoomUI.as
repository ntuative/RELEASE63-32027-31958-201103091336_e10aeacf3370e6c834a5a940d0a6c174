package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1060:IHabboHelp;
      ...
      {
         this.var_1424 = RoomDesktop.const_549;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_487.release(new IIDHabboSoundManager());
            this.var_487 = null;
         }
         ...
         {
            this.var_1060.release(new IIDHabboHelp());
            this.var_1060 = null;
         }
         ...
         {
            this.var_934.release(new IIDHabboModeration());
            this.var_934 = null;
         }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_185 = param2 as IHabboToolbar;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1804 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_304.events.addEventListener(AdEvent.const_484,this.adEventHandler);
            this.var_304.events.addEventListener(AdEvent.const_506,this.adEventHandler);
            this.var_304.events.addEventListener(AdEvent.const_463,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1060 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_934 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_934);
      }
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_487 = param2 as IHabboSoundManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_239,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_500,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_557,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_433,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1203,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_814,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_812,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_173,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_879,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_885,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_444,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_434,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionWelcomeGiftEvent.const_117,this.roomSessionEventHandler);
         }
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_98:
               if(param1.session != null)
               {
                  ...
                  this.var_185.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.ZOOM));
                  this.var_185.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.MEMENU));
                  this.var_185.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_240:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_814:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_730,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_896,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_643,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_526,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_430,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_63,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_676,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_875,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_542,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_294,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_658,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_234,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_692,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_467,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_730)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_430 || param1.type == RoomEngineEvent.const_526)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_896:
               _loc5_ = false;
               ...
               if(this._roomEngine != null)
               {
                  ...
                  {
                     _loc7_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_92,HabboToolbarIconEnum.ZOOM);
                     _loc7_.iconState = "2";
                     this.var_185.events.dispatchEvent(_loc7_);
                  }
                  else
                  {
                     _loc5_ = true;
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_807);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_874);
               ...
               if(this._config.getKey("purse.widget.enabled","0") == "1")
               {
                  ...
                  _loc3_.initializeWidget(RoomWidgetEnum.const_381);
               }
               if(!_loc5_)
               {
               ...
               if(this.var_1424 != RoomDesktop.const_549)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_323,this.var_1424);
               }
               if(this.var_304 != null)
               {
            ...
            case RoomEngineEvent.const_643:
               ...
               break;
            case RoomEngineRoomColorEvent.const_676:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.sessionDataManager = this.var_288;
         _loc3_.roomSessionManager = this.var_15;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_473;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this.var_185;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1804;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_304;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1060;
         _loc3_.moderation = this.var_934;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_487;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_549)
            {

package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_772:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_313 != null)
         {
            ...
            {
               _loc2_ = this.var_313.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1182)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_821,RoomWidgetChatSelectAvatarMessage.const_864];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_821:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_41) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1187))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_41) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1187))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_864:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_187)
                           {
                              _loc13_ = this.var_313.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_432.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_625.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_187:
                                       _loc13_ = this.getPetImage(_loc16_);
                                       _loc12_ = uint(this.var_625.getValue(_loc16_));
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_89,null,this);
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_625.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_187)
                                    {
                                       this.var_313.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1183 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1183);
            }
            if(this.var_772 == null)
            {
               ...
               this.var_509.y = 0;
               this.var_509.z = 0;
               this.var_772 = _loc4_.getScreenPoint(this.var_509);
               this.var_1183 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_509.x = 0;
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_772.x || _loc8_.y != this.var_772.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_772,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_313)
         {
            _loc2_ = this.var_313.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_89,this);
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_625.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1883.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1883.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_313)
            {
               this.var_313.add(_loc3_,param2);
            }
         }
      }
   }

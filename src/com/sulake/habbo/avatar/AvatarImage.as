package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1305:String = "Default";
      
      private static const const_1306:int = 2;
      
      private static const const_1304:String = AvatarSetType.const_35;
      ...
      protected var var_2024:int;
      
      protected var var_277:IActiveActionData;
      
      protected var var_730:Boolean;
      
      protected var var_721:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_263:AvatarImageCache;
      
      protected var _figure:AvatarFigureContainer;
      
      protected var var_537:IAvatarDataContainer;
      
      protected var var_322:Array;
      ...
      protected var var_1254:Boolean = false;
      ...
      private var var_2626:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this._figure = param3;
         this.var_263 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1304,const_1306);
         this.var_322 = new Array();
         this.var_856 = new ActiveActionData(AvatarAction.const_376);
         this.var_856.definition = this._structure.getActionDefinition(const_1305);
         this.resetActions();
      ...
      {
         param2 += this.var_1665;
         if(param2 < AvatarDirectionAngle.const_1102)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_616,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_267.length == 1 && this.var_89 == this.var_2024)
         {
            return this.var_89 + this.var_498 + this.var_616 % 4;
         }
         if(this.var_267.length == 2)
         {
            for each(_loc1_ in this.var_267)
            {
               ...
               {
                  return this.var_89 + this.var_498 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_616 % 11;
                  return this.var_89 + "_" + this.var_2024 + this.var_498 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2628 || param2 != this.var_2626 || param1 != this.var_2627)
         {
            this.var_2628 = param3;
            this.var_2626 = param2;
            this.var_2627 = param1;
            this.var_1846 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_277.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1254 || this.var_45 == null || (this.var_45.width != _loc5_.width || this.var_45.height != _loc5_.height))
         {
            if(this.var_45 != null && !this.var_1254)
            {
               this.var_45.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_277.definition.geometryType,this.var_89);
         this.var_45.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_616);
         ...
         {
            if(this.var_537.paletteIsGrayscale)
            {
               ...
               this.var_45 = _loc13_;
               this.var_45.paletteMap(this.var_45,this.var_45.rect,new Point(0,0),this.var_537.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_277.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_277.definition.geometryType,this.var_89);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_616);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_322.push(new ActiveActionData(param1,param2,this.var_616));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_277 = this.var_856;
         this.var_277.definition = this.var_856.definition;
         this.resetBodyPartCache(this.var_856);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_267)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_498 = "";
         this.var_267 = this._structure.sortActions(this.var_322);
         if(this.var_267 == null)
         {
            this.var_721 = new Array(0,0,0);
            if(this.var_1449 != "")
            {
               _loc1_ = true;
               this.var_1449 = "";
         ...
         {
            this.var_721 = this._structure.getCanvasOffsets(this.var_267,this._scale,this.var_89);
            for each(_loc4_ in this.var_267)
            {
               this.var_498 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_317)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1450 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1450 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1449 != this.var_498)
            {
               _loc1_ = true;
               this.var_1449 = this.var_498;
            }
         }
         this.var_1324 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_267)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_820 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1665 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_537 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_279 || _loc1_.actionType == AvatarAction.const_238 || _loc1_.actionType == AvatarAction.const_344)
               {
                  this.var_820 = true;
               }
            }

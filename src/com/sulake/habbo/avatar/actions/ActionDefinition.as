package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2450 = parseInt(param1.@precedence);
         this.var_2454 = String(param1.@activepartset);
         this.var_2451 = String(param1.@assetpartdefinition);
         this.var_2452 = String(param1.@lay);
         this.var_750 = String(param1.@geometrytype);
         this.var_2453 = Boolean(parseInt(param1.@main));
         this.var_2456 = Boolean(parseInt(param1.@method_8));
         this.var_2455 = Boolean(parseInt(param1.@animation));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_721.add(param1,new Map());
         }
         var _loc4_:Map = this.var_721.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_721.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1746[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2449;
         }
         return _loc2_;
      }

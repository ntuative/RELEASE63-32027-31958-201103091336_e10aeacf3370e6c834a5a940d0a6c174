package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      {
         if(param1 == null || this.var_483 == null)
         {
            return;
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_483.length > 0)
         {
            _loc1_ = this.var_483.pop() as IPetDataListener;
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         if(param2 == AvatarScaleType.const_89)
         {
            _loc5_ = 0;
         ...
         {
            if(this.var_1379.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_590.getValue(_loc6_) == null)
               {
                  ...
                  this.var_590.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_483.indexOf(param3) == -1)
                  {
                     this.var_483.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_590.getKeys())
         {
            _loc5_ = this.var_590.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_279.indexOf(_loc2_);
         if(_loc3_ != -1)
         {

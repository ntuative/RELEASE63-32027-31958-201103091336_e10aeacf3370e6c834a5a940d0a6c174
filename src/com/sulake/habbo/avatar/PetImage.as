package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_263:AvatarImageCache;
      ...
      private var var_537:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1325);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_277.definition.geometryType);
         if(this.var_45 == null || _loc4_ != null && (this.var_45.width != _loc4_.width || this.var_45.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_277.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_616);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc16_ = this.var_1325 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_89)
               {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_616);
                  _loc20_ = this.var_89;
                  _loc21_ = 1;
                  switch(this.var_89)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_616);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_616);
                  _loc21_ = this.var_89;
                  _loc22_ = 1;
                  switch(this.var_89)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_498 = this.var_498 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_398:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1519:
                  case AvatarAction.const_1451:
                  case AvatarAction.const_1411:
                  case AvatarAction.const_1124:
                  case AvatarAction.const_1064:
                  case AvatarAction.const_1416:
                  case AvatarAction.const_1518:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_322.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_856);
         this.getCache().resetBodyPartCache(this.var_856);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1326 = this._structure.sortActions(this.var_322);
         ...
         {
            this.var_721 = this._structure.getCanvasOffsets(this.var_1326,this._scale,this.var_89);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1326)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_344)
               {
                  this.var_820 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1132 = _loc4_.id;
                     this.var_1664 = _loc4_.breed;
                     break;
                  }
               }
            }

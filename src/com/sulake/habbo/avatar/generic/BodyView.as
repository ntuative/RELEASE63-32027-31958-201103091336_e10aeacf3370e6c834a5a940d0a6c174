package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_593:String = "tab_boy";
      
      private const const_592:String = "tab_girl";
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_68,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_68.controller.gender)
         {
            case FigureData.const_78:
               activateTab(this.const_593);
               inactivateTab(this.const_592);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_592);
               inactivateTab(this.const_593);
         }
      }

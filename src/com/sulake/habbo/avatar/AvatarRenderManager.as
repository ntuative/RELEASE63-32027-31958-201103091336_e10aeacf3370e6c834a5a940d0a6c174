package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2016:String = "hd-99999-99999";
      ...
      private var var_751:PaletteManager;
      ...
      private var var_1818:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_559 = RenderMode.const_1563;
         ...
         this.var_101.add(AvatarType.const_114,_loc4_);
         ...
         this.var_101.add(AvatarType.const_72,_loc4_);
         ...
         this.var_751 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_310.init();
         this.var_751.init();
         _loc2_ = this.var_101.getValue(AvatarType.const_114) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_101.getValue(AvatarType.const_72) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_101.getValue(AvatarType.const_114) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1053,this.onFigureDataDownloadDone);
      ...
      private function checkIfReady() : void
      {
         if(!this.var_976)
         {
            if(this.var_2588 && this.var_2589 && this.var_2590)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_101.getValue(AvatarType.const_114) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1818)
         {
            this.var_1818 = new AvatarFigureContainer(this.const_2016);
         }
         this.var_228.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1818,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_309 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_309.getKeys())
         {
            _loc4_ = this.var_309.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_310.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1624)
         {
            _loc6_ = !this.var_310.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_310.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_101.getValue(AvatarType.const_72) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_309.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_101.getValue(AvatarType.const_72);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_309.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_309.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_101.getValue(AvatarType.const_114) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_72:
               _loc3_ = this.var_101.getValue(AvatarType.const_72) as AvatarStructure;
               break;
            default:

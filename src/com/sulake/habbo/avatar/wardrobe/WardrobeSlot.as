package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      private function createView() : void
      {
         ...
         this.var_381 = this.var_17.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function updateView() : void
      {
         ...
         if(this._figure && this.var_1501)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_89,this.var_994,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_35,parseInt(FigureData.const_906));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this.var_994 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1960,this);
               this.updateView();
               break;
            case "get_button":
               if(this._figure)
               {
                  this._controller.loadAvatarInEditor(this._figure,this.var_994,this._controller.clubMemberLevel);
               }
         }
      }

package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_895:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_611.width,this.var_611.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_611,this.var_611.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_947.width,this.var_947.height,true,0);
            _loc5_ = this.var_947.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_895.colorTransform);
         ...
         if(_loc4_)
         {
            if(this.var_895)
            {
               switch(this.var_895.clubLevel)
               {
                  case HabboClubLevelEnum.const_54:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_41:
                     _loc4_.style = HabboIconType.const_806;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_44:
                     _loc4_.style = HabboIconType.const_828;
                     _loc4_.visible = true;
               }
            }
            else

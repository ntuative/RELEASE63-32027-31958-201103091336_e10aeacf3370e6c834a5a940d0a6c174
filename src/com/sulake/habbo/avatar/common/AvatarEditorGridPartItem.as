package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_711:IFigurePartSet;
      ...
      private const const_1979:int = 13421772;
      
      private const const_1978:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         this.var_711 = param3;
         this._window = param1;
         this.var_1288 = this._window.findChildByTag("BG_COLOR");
         this._colors = param4;
         this.var_1698 = param5;
         if(param3 == null)
         {
            this.var_656 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1699 = Math.max(this.var_1699,_loc6_.colorLayerIndex);
            }
         }
         this.var_397 = this.var_68.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_656 != null && !this.var_1698)
            {
               _loc3_ = this.var_656;
            }
            else
         ...
         if(_loc2_)
         {
            if(this.var_711)
            {
               switch(this.var_711.clubLevel)
               {
                  case HabboClubLevelEnum.const_54:
                     _loc2_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_41:
                     _loc2_.style = HabboIconType.const_806;
                     break;
                  case HabboClubLevelEnum.const_44:
                     _loc2_.style = HabboIconType.const_828;
               }
            }
            else
            {
         ...
         if(this.isSelected)
         {
            this.var_1288.color = this.const_1979;
         }
         else
         {
            this.var_1288.color = this.const_1978;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:IAvatarFigureContainer = this.var_397.createFigureContainer(this.partSet.type + "-" + this.partSet.id);
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_328[_loc6_] + "_" + FigureData.const_137;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_579 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1700)
               {
                  ...
                  this.var_1700 = _loc9_.content as BitmapData;
               }
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1698 && _loc2_.colorLayerIndex > 0)
               {

package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_413:AssetLoaderStruct;
      
      private var var_915:Timer;
      ...
      private const const_2011:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_413 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_915 = new Timer(this.const_2011,1);
         this.var_915.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_413)
         {
            this.var_413.addEventListener(AssetLoaderEvent.const_27,this.onConfigurationComplete);
            this.var_413.addEventListener(AssetLoaderEvent.const_46,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_413)
         {
            this.var_413.removeEventListener(AssetLoaderEvent.const_27,this.onConfigurationComplete);
            this.var_413.removeEventListener(AssetLoaderEvent.const_46,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         else
         {
            ...
            if(this.var_1406.indexOf("?") > 0)
            {
               _loc2_ = this.var_1406 + "&retry=" + this.var_916;
            }
            else
            {
               _loc2_ = this.var_1406 + "?retry=" + this.var_916;
            ...
            this.var_413 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2523,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1775)
         {
            this.var_1124.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_483[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_483[_loc3_] = _loc6_;
            }
      ...
      {
         var _loc1_:* = null;
         while(this.var_734.length > 0 && this.var_733.length < this.const_1539)
         {

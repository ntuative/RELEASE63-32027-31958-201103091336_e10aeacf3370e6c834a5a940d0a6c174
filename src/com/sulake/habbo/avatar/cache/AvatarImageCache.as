package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1720:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1359:IAvatarImage;
      ...
      private var var_364:IActiveActionData;
      ...
      private var var_2579:ByteArray;
      
      private var var_2580:ImageData;
      
      private var var_880:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_750 == GeometryType.const_1197 && param1 == GeometryType.const_1010 || this.var_750 == GeometryType.const_1010 && param1 == GeometryType.const_1197)
         {
            this.var_750 = param1;
            this.var_86 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_364 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_364;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_364 || !this.var_364.definition))
         {
            if(this.var_364.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_364.definition.state + "." + this.var_364.actionParameter);
               _loc13_ = param2 - this.var_364.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_364.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_580)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1359.getFigure(),_loc5_,this.var_750,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_406 == null)
         {
            ...
            this.var_406 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_364);
            if(this.var_406 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_86)
         {
            this.var_86 = this._structure.getCanvas(this._scale,this.var_750);
            if(!this.var_86)
            {
               return null;
            }
            this.var_2581 = new Point(0,this.var_86.height - int(this.var_86.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1391[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_663 || _loc10_ == AvatarAction.const_344;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1432 = this.var_115.bodyPartId;
               this.var_180 = this.var_115.partType;
               this.var_1815 = this.var_115.partId;
               this._frame = this.var_115.getFrameIndex(param3);
               _loc5_ = param1;
               _loc7_ = false;
               if(_loc6_)
               {
                  if(_loc9_ == "wav" && (this.var_180 == "lh" || this.var_180 == "ls" || this.var_180 == "lc" || this.var_180 == "lhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "drk" && (this.var_180 == "rh" || this.var_180 == "rs" || this.var_180 == "rc" || this.var_180 == "rhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "crr" && this.var_180 == "rhs")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_180 == "ri")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_180 == "cp")
                  {
                     _loc7_ = true;
                  }
                  else
                  {
                     ...
                     if(this.var_115.flippedPartType != this.var_180)
                     {
                        this.var_180 = this.var_115.flippedPartType;
                     }
                  }
               }
               this.var_1431 = this._scale + "_" + this.var_115.action.assetPartDefinition + "_" + this.var_180 + "_" + this.var_1815 + "_" + _loc5_ + "_" + this._frame;
               this.var_421 = this._assets.getAssetByName(this.var_1431) as BitmapDataAsset;
               if(this.var_421 == null)
               {
                  this.var_1431 = this._scale + "_std_" + this.var_180 + "_" + this.var_1815 + "_" + _loc5_ + "_0";
                  this.var_421 = this._assets.getAssetByName(this.var_1431) as BitmapDataAsset;
               }
               if(!(!this.var_421 || !this.var_421.content))
               {
                  ...
                  {
                     this.var_880 = this._structure.renderManager.paletteManager.getPalette(this.var_115.paletteMapId);
                     if(this.var_880 != null)
                     {
                        this.var_937 = this.var_421.content as BitmapData;
                        this.var_179 = new BitmapData(this.var_937.width,this.var_937.height);
                        this.var_2579 = this.var_880.colorize(this.var_937.getPixels(this.var_937.rect));
                        this.var_179.setPixels(this.var_179.rect,this.var_2579);
                     }
                     else
                     {
                        this.var_179 = (this.var_421.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1432 == AvatarBodyPartType.const_213 || this.var_1432 == AvatarBodyPartType.const_1612 || this.var_1432 == AvatarBodyPartType.const_1626) && this.var_115.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_179.colorTransform(this.var_179.rect,this.var_115.color.colorTransform);
                  }
                  if(this.var_115.isBlendable)
                  {
                     this.var_179.colorTransform(this.var_179.rect,this.var_115.blendTransform);
                  }
                  this.var_938 = this.var_421.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_57)
                     {
                  ...
                  this.var_2580 = new ImageData(this.var_179,this.var_938,_loc7_);
                  this.var_939.push(this.var_2580);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_939,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2581.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_57)
            {
         ...
         _loc8_ = this.var_939.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_939.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }

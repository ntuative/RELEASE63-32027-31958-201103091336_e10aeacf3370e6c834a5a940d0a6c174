package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1515 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2033 = parseInt(_loc2_,16);
         this.var_2032 = parseInt(_loc3_,16);
         ...
         this.var_1761 = new ColorTransform(this.var_1622,this.var_1621,this.var_1624,this._alphaMultiplier);
         this.var_1009 = this.generatePaletteMapForGrayscale(this.var_2032,this.var_2033);
      }

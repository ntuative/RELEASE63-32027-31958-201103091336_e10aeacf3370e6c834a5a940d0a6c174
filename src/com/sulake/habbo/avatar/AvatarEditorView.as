package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1982:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1126 = [];
         this.var_1292 = [AvatarEditorFigureCategory.const_773,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_213,AvatarEditorFigureCategory.const_780,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_109];
         super();
         ...
         if(param4 == null)
         {
            param4 = this.var_1292;
         }
         for each(_loc6_ in param4)
         {
            this.var_1126.push(_loc6_);
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1292);
         }
         if(param1.length != this.var_1126.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1126.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2527 = this.canChangeOutfit();
            this.var_414.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1126.indexOf(_loc4_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1292;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_41) && (this.var_1777 == AvatarEditorSideCategory.const_109 || this.var_2528))
         {
      ...
      {
         if(this.var_1777 == AvatarEditorSideCategory.const_109)
         {
            this.var_2528 = false;

package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1307:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1309:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1068:AvatarEditorHandler;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_474)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_188)
         {
            ...
            _loc3_ = this.var_566["null"];
            _loc2_.loadAvatarData(const_1307,FigureData.const_78);
            _loc3_.loadAvatarData(const_1309,FigureData.FEMALE);
            this.var_97 = new Map();
            this.var_474 = new Map();
            this.var_97.add(AvatarEditorFigureCategory.const_773,new BodyModel(this));
            this.var_97.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_97.add(AvatarEditorFigureCategory.const_213,new TorsoModel(this));
            this.var_97.add(AvatarEditorFigureCategory.const_780,new LegsModel(this));
            ...
            this.var_474.add(AvatarEditorSideCategory.const_109,new WardrobeModel(this));
            this.var_474.add(AvatarEditorSideCategory.const_522,new ClubPromoModel(this));
            this.var_188 = true;
         }
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_243 == null)
            {
               this.var_243 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_62,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_243.addChild(this.var_17.window);
               if(param5)
               {
                  this.var_243.center();
               }
            ...
            this.var_243.visible = !this.var_243.visible;
         }
         this.var_17.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_773);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_474.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_473 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_857 = this.var_473.getFigureData(AvatarType.const_114);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1068 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_566[this.var_994];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1329 != null)
         {
            ...
            this.var_1329.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1669;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1067 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1308)
                  {
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_473.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_473.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1619)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1067 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1067 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_474.getValue(AvatarEditorSideCategory.const_109);
      }

package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      private var var_1231:Dictionary;
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2453 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         this.var_1231 = new Dictionary();
         this.var_1950 = new Array();
         for each(_loc4_ in param1.avatarset)
         {
            _loc3_ = new AvatarSet(_loc4_);
            this.var_1231[String(_loc4_.@id)] = _loc3_;
         }
         for each(_loc5_ in param1.bodypart)
         {
            this.var_1950.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_1950.concat();
      ...
      public function findAvatarSet(param1:String) : AvatarSet
      {
         ...
         for each(_loc2_ in this.var_1231)
         {
      ...
      public function get isMain() : Boolean
      {
         ...
         for each(_loc1_ in this.var_1231)
         {
            if(_loc1_.isMain)
            {
               return true;

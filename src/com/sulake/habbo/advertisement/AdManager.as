package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1010:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2037 = this._config.getKey("interstitial.enabled","FurnitureEcotronBoxLogic") == "true";
         this.var_2035 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2034 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1516 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_207 != null && this.var_207.running)
         {
            this.var_207.reset();
            return false;
         }
         ...
         if(this.var_1516 > 0 && this.var_1517 >= this.var_1516)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1012;
         if(_loc1_ > this.var_2035)
         {
            ++this.var_1517;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1260 = _loc2_.imageUrl;
         this.var_2036 = _loc2_.clickUrl;
         this.var_1012 = getTimer();
         if(this.var_1260 != "")
         {
            _loc3_ = this.var_1260;
            ...
            {
               this.var_207 = new Timer(this.var_2034,1);
               this.var_207.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_207.running)
            {
               this.var_207.reset();
            }
            this.var_207.start();
            _loc4_ = new URLRequest(this.var_1260);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_506,0,0,param1.bitmapData,this.var_2036));
            this.var_1012 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_484));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1259 = _loc2_.imageUrl;
         this.var_1518 = _loc2_.clickUrl;
         if(this.var_1259 != "" && this.var_1518 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1259);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_463,0,0,_loc4_,this.var_1518,this.var_1010,this.var_1011));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1010 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1011 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }

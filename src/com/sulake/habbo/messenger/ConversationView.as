package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1269:int = 10;
      
      private static const const_921:int = 100;
      
      private static const const_1270:int = 20;
       
      
      private var var_126:HabboMessenger;
      
      private var var_2202:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_126 = param1;
         this.var_1607 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_61 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2202 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_921 + const_1270)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshListDims() : void
      {
         ...
         this.var_61.autoArrangeItems = false;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_61.numListItems)
         {
            _loc2_ = ITextWindow(this.var_61.getListItemAt(_loc1_));
      ...
      {
         param1.width = this.var_61.width;
         param1.height = param1.textHeight + const_1269;
         param1.invalidate();
      }
      ...
      private function findAddIndex() : int
      {
         ...
         while(_loc1_ < this.var_61.numListItems)
         {
            _loc2_ = this.var_61.getListItemAt(_loc1_);
            if(!_loc2_.visible)
            {
               return _loc1_;
            }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_464 == null || _loc1_.id != this.var_464.id)
         {
            this.var_464 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_464.followingAllowed)
         {
            this.var_1607.enable();
         }
         else
         {
            this.var_1607.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_61.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_464.messages.length - const_921);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_464.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_464.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      {
         var _loc4_:ITextWindow = this.var_61.getListItemAt(param2) as ITextWindow;
         if(_loc4_ == null)
         {
            if(!param1)
            {
            ...
            _loc4_.width = this.var_61.width;
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_802 || param3.type == Message.const_708 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_464.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_126.send(new FollowFriendMessageComposer(this.var_464.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_1129)
         {
            return 4294927974;
         }
         if(param1 == Message.const_757)
         {
            return 4293454056;
         }
         if(param1 == Message.const_712)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1011)
         {
            return 4288269465;
         }
         return 4291611852;

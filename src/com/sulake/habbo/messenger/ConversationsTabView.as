package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         super();
         this.var_126 = param1;
         this.var_170 = IWindowContainer(param2.findChildByName("content"));
         this.var_883 = IWindowContainer(param2.findChildByName("conversationstab"));
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_170.findChildByName("convo_bg"));
         _loc3_.bitmap = this.var_126.getButtonImage("convo_bg");
      }
      
      public function getTabCount() : int
      {
         return Math.floor(this.var_883.width / this.var_1102);
      }
      ...
      {
         var _loc3_:IWindowContainer = this.var_883.getChildAt(param1) as IWindowContainer;
         if(_loc3_ == null)
         {
            if(param2 == null)
            {
      ...
      private function refreshAsArrow(param1:int, param2:Boolean) : void
      {
         ...
         var _loc4_:int = this.var_883.width % this.var_1102;
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_164 ? this.var_126.conversations.findConversation(param2.id) : this.var_126.conversations.openConversations[_loc3_ + this.var_126.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }

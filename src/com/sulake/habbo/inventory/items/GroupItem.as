package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_190:Boolean;
      
      protected var var_2777:String;
      ...
      protected var var_812:int = 0;
      
      protected var var_656:BitmapData;
      
      protected var var_2610:int;
      
      protected var var_1510:Boolean;
      
      protected var var_2012:Boolean;
      
      protected var var_2776:BitmapData;
      
      private const const_1979:int = 8947848;
      
      private const const_1978:int = 13421772;
      
      private const const_1711:Number = 1;
      
      private const const_1710:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2777 == FurniModel.const_43)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1332));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2013);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_836)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1710;
               _loc1_.blend = this.const_1710;
            }
            else
            {
               this._window.blend = this.const_1711;
               _loc1_.blend = this.const_1711;
            }
         }
         if(this.isSelected)
         {

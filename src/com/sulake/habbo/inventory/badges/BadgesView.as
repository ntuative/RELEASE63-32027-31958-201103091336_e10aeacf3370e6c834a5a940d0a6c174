package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1161 = this.var_17.findChildByName("inactive_items") as IItemGridWindow;
         this.var_1161.procedure = this.inactiveGridEventProc;
         this.var_1160 = this.var_17.findChildByName("active_items") as IItemGridWindow;
         this.var_1160.procedure = this.activeGridEventProc;
      }

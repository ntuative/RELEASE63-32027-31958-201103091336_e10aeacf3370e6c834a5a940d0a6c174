package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_61 = IItemListWindow(this.var_17.getChildByName("achievements_itemlist"));
         this.var_396 = new Timer(1000,1);
         this.var_396.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_396)
            {
               this.var_396.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_396.reset();
               this.var_396 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_396.running);
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = this.var_288.getBadgeImage(param2.badgeId);

package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_436:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_436 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_203)
            {
               this.var_203.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_203.stop();
               this.var_203 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1897 = this.createMinimizedWindow();
         }
         if(!this.var_2683)
         {
            return this.var_72;
         ...
         if(this.var_72)
         {
            ...
            switch(this.var_21.state)
            {
               ...
               case TradingModel.const_345:
                  ...
                  break;
               case TradingModel.const_301:
                  _loc1_.enable();
                  _loc1_.caption = "${inventory.trading.confirm}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_472:
                  _loc1_.disable();
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_203 = new Timer(1000,3);
            this.var_203.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_203.reset();
         this.var_203.repeatCount = 3;
         this.var_203.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_203.currentCount));
         if(this.var_203.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1214)
            {
            ...
            this.var_436.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_544);
            this.var_436.show();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT)
         {
            this.var_436.hideDelayed();
         }
      }

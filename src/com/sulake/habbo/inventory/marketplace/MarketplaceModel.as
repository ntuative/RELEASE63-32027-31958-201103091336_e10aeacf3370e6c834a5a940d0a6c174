package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this._controller != null && this._controller.furniModel != null && this.var_210 != null)
         {
            this._controller.furniModel.removeLockFrom(this.var_210.id);
            this.var_210 = null;
         }
      }
      ...
      {
         if(this.var_210 != null || param1 == null)
         {
            return;
         }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_210 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_210.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_210 is FloorItem ? 1 : 2;
         this.var_2244 = _loc2_;
         this.var_2243 = this.var_210.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_210.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this.var_17.showMakeOffer(this.var_210);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this.var_17.showBuyTokens(this.var_1631,this.var_1632);
         }
      }
      ...
      {
         if(param1 != this.var_2244 || param2 != this.var_2243)
         {
            return;
         }
         if(!this.var_17)
         ...
         this.var_17.updateAveragePrice(param3,this.var_2224);
      }

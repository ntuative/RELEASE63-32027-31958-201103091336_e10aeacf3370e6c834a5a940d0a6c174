package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2029:int = 0;
      
      private const const_963:int = 1;
      
      private const const_1704:int = 2;
      
      private const const_1703:int = 3;
      
      private const const_1713:int = 42;
      
      private const const_1714:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_487 = param6;
         this.var_487.events.addEventListener(SongInfoReceivedEvent.const_752,this.onSongInfoReceivedEvent);
         this.var_409 = new Map();
         this.var_409.add(FurniModel.const_43,new FurniGridView(this.var_68,FurniModel.const_43,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_409.add(FurniModel.const_50,new FurniGridView(this.var_68,FurniModel.const_50,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_487)
            {
               this.var_487.events.removeEventListener(SongInfoReceivedEvent.const_752,this.onSongInfoReceivedEvent);
               this.var_487 = null;
            }
            this.var_599 = null;
            this._disposed = true;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_409.getValue(this.var_408);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_68.getCategoryContent(this.var_408);
         if(!this.var_68.isListInited())
         {
            _loc2_ = this.const_963;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1704;
         }
         else
         {
            _loc2_ = this.const_1703;
         }
         if(this.var_2384 == _loc2_)
         {
            return;
         }
         ...
         switch(_loc2_)
         {
            case this.const_963:
               ...
               break;
            case this.const_1704:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1703:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_68.getGroupItemInIndex(_loc3_,this.var_408);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_355)
            {
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1100)
               {
                  _loc21_ = this.var_487.musicController.getSongInfo(_loc5_.extra);
                  if(_loc21_ != null)
                  {
                  ...
                  {
                     this.var_487.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
                     this.var_599.push(_loc5_.extra);
                  }
               }
            }
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1100)
               {
                  _loc22_ = this.var_487.musicController.getSongInfo(_loc5_.extra);
                  if(_loc22_ != null)
                  {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1714)
         {
            _loc3_ = this.const_1714;
         }
         else if(_loc3_ < this.const_1713)
         {
            _loc3_ = this.const_1713;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_59)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_387);
            }
         }
      }
      ...
      {
         if(this.var_599.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_599.indexOf(param1.id as Number) != -1)
            {
               this.var_599.splice(this.var_599.indexOf(param1.id as Number),1);
            }
         }
      }
   }

package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_387:String = "pets";
      ...
      private var var_1741:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_234,this.onObjectPlaced);
         this._catalog = param7;
         this.var_487 = param8;
         this.var_592 = new Timer(const_1325,1);
         this.var_592.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2437 = XML(_loc10_.content);
         this.clearFurniList();
         this.var_17 = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_487);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_234,this.onObjectPlaced);
               }
            ...
            {
               this.var_592.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_592.stop();
               this.var_592 = null;
            }
            if(this.var_196 != null)
            {
               this.var_196.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_196.stop();
               this.var_196 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            ...
            else
            {
               ...
               {
                  this.var_1741 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1741;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_355)
         {
         ...
         if(this.var_894 == null)
         {
            this.var_894 = this._windowManager.buildFromXML(this.var_2437) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_894.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_43,const_50];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_196 = new Timer(param1,1);
            this.var_196.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_196.start();
         }
         else
         {
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_43,const_50];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_43,const_50];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_591.add(const_43,new Array());
         this.var_591.add(const_50,new Array());
         if(this.var_17 != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_276;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_355 || _loc3_.category == FurniCategory.const_347 || _loc3_.category == FurniCategory.const_334)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1381 && param1.type == RoomEngineObjectEvent.const_234)
         {
            this.var_1381 = false;
         }
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_591.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_836)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;

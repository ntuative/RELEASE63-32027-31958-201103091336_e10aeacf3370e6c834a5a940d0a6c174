package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2826:IWindowContainer;
      
      private var _controller:HabboInventory;
      
      private var var_185:IHabboToolbar;
      
      private var var_1215:Boolean = true;
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_185 != null && this.var_1215)
         {
            this.var_185.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1215 = false;
         }
         this._controller.inventoryViewOpened(this.var_790);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_789 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this.var_185 != null && this.var_1215)
            {
               this.var_185.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_55,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1215 = false;
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_790);
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_185.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_150,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1933);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_789 == InventoryCategory.const_147)
            {
               this.toggleCategoryView(InventoryCategory.const_147);
            }
            else if(this.var_789 == InventoryCategory.const_75)
            {

package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_246:IItemGridWindow;
      ...
      private var var_342:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_246 = this.var_17.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_342);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_581.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_246.removeGridItem(_loc2_.window);
      ...
      private function selectFirst() : void
      {
         ...
         this.setSelectedGridItem(this.var_581.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_581.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_246.addGridItem(_loc2_.window);
            this.var_581.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_342.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_59)
         {
            ...
            {
               case "tab_floor":
                  this.var_68.switchCategory(FurniModel.const_43);
                  break;
               case "tab_wall":
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_342 != null)
         {
            this.var_342.setSelected(false);
         }
         this.var_342 = param1;
         if(this.var_342 != null)
         {
            this.var_342.setSelected(true);
         }

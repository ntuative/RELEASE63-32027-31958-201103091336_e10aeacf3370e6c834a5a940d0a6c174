package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1333:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_569 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_569.width;
         this.var_90 = this.var_569.height;
         this.var_1071 = param5;
         this.var_859 = param6;
         this.var_218 = Math.floor(this.var_1071 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1071,this.var_859);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_568 = this.resolveRowCountFromList();
         if(this.var_568 == 0)
         {
            this.var_26 = new BitmapData(this.var_1071,this.var_859);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_218 * this._thumbWidth,this.var_1071),Math.max(this.var_568 * this.var_90,this.var_859),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_568)
         {
            _loc4_ = 0;
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1333.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_859)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_859);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_569.width,this.var_569.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_569.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_569,this.var_569.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {

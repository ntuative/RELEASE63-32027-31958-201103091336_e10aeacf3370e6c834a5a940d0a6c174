package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1041:IRoomSession;
      ...
      private const const_2006:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_483,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_50.getValue(InventoryCategory.const_75));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_50.getValue(InventorySubCategory.const_276));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_50.getValue(InventoryCategory.const_895));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_50.getValue(InventoryCategory.const_293));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_50.getValue(InventoryCategory.const_383));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_50.getValue(InventoryCategory.const_147));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_50.getValue(InventoryCategory.const_380) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1387 = new IncomingMessages(this);
      ...
      {
         this.var_288 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_483,this.roomSessionEventHandler);
         this.initInventory();
      }
      
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_487 = IHabboSoundManager(param2);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_98:
               this.var_1041 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_483:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_288 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_185 || !this.var_487)
         {
            return;
         }
         this.var_17 = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this.var_17.setToolbar(this.var_185);
         this.var_50 = new Map();
         ...
         this.var_50.add(InventoryCategory.const_380,_loc1_);
         var _loc2_:FurniModel = new FurniModel(this,_loc1_,this._windowManager,this._communication,this._assetLibrary,this._roomEngine,this._catalog,this.var_487);
         this.var_50.add(InventoryCategory.const_75,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_288);
         this.var_50.add(InventoryCategory.const_293,_loc3_);
         ...
         this.var_50.add(InventoryCategory.const_895,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_288);
         this.var_50.add(InventoryCategory.const_383,_loc5_);
         ...
         this.var_50.add(InventorySubCategory.const_276,_loc6_);
         ...
         this.var_50.add(InventoryCategory.const_147,_loc8_);
         this.var_188 = true;
         if(this.var_2461)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_276:
               this.var_17.toggleCategoryView(InventoryCategory.const_75,false);
         }
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2006);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_682));
      }

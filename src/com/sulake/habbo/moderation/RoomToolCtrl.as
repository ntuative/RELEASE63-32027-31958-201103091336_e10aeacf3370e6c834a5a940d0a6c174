package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_556:Boolean = true;
      
      private var var_920:ICheckBoxWindow;
      
      private var var_1413:ICheckBoxWindow;
      
      private var var_1414:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_337));
      ...
      {
         this.var_61 = IItemListWindow(this._frame.findChildByName("list_cont"));
         ...
         this.var_920 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1413 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1414 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_61.getListItemByName(param2));
         ...
         if(!param1.exists)
         {
            this.disposeItemFromList(this.var_61,_loc3_);
            this.disposeItemFromList(this.var_61,this.var_61.getListItemByName("event_spacing"));
            return;
         }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_809,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_556 || this.var_497.text == "")
         {
            this.var_35.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_920.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1665,_loc2_,this.var_497.text,"",""));
         if(this.var_1413.isSelected || this.var_1414.isSelected || this.var_920.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1413.isSelected,this.var_1414.isSelected,this.var_920.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1606);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1459);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1117.selection];
         if(_loc3_ != null)
         {
            this.var_556 = false;

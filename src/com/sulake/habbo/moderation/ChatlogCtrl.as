package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_815:Array = [];
      
      private static var var_1524:int = 1000;
      ...
      private var var_1525:IMessageComposer;
      ...
      {
         this.var_659 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_658 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         ...
         this.var_35.connection.send(this.var_1525);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_815.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_658.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_815.length < var_1524)
         {
            ...
            param1.width = this.var_658.width;
            param1.height = this.var_658.height;
            var_815.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1527[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1266.getValue(param2.chatterName))
            {
               this.var_1266.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1266.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1265)
         {

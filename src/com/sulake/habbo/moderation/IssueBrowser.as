package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2013:String = "my_issues";
      
      private const const_2012:String = "open_issues";
      
      private const const_2014:String = "picked_issues";
      ...
      private var var_1788:IIssueBrowserView;
      
      private var var_1787:IIssueBrowserView;
      
      private var var_1789:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_260 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_260.numTabItems)
            {
               _loc5_ = this.var_260.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_59,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_260 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_260 == null || this.var_260.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_260.selector.getSelectableByName("open_issues");
         this.var_260.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_358.view.width = this.var_260.container.width;
         this.var_358.view.height = this.var_260.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2013:
               ...
               {
                  this.var_1788 = new MyIssuesView(this.issueManager,this,this.var_260.container);
               }
               return this.var_1788;
            case this.const_2012:
               if(this.var_1787 == null)
               {
                  this.var_1787 = new OpenIssuesView(this.issueManager,this,this.var_260.container);
               }
               return this.var_1787;
            case this.const_2014:
               if(this.var_1789 == null)
               {
                  this.var_1789 = new PickedIssuesView(this.issueManager,this,this.var_260.container);
               }

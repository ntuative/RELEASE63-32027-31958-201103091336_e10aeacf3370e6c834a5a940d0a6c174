package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_792:IssueMessageData = null;
      
      private var var_793:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2372 = param2.pickerUserId;
         this.var_2718 = param2.pickerUserName;
         this.var_1314 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1216 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1217;
         }
         if(this.var_792 == null || param1.timeStamp < this.var_792.timeStamp)
         {
            this.var_792 = param1;
         }
         if(this.var_793 == null || param1.priority > this.var_793.timeStamp)
         {
            this.var_793 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1216 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1217;
            }
            if(this.var_792 == _loc2_)
            {
               this.var_792 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_793;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_792;
         if(_loc2_ == null)
         {

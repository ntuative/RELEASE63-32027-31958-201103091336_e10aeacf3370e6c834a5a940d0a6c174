package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_985:Array = [];
      
      private static var var_1934:int = 200;
      ...
      {
         this.var_791 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
         ...
         this.var_61 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1436;
      }
      ...
      private function populateRoomRow(param1:RoomVisitData, param2:Boolean) : void
      {
         ...
         _loc7_.color = _loc4_;
         this.addRoomRowToList(_loc3_,this.var_61);
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_985.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_791.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_985.length < var_1934)
         {
            ...
            param1.width = this.var_791.width;
            param1.height = this.var_791.height;
            var_985.push(param1);
         }
         else
         {
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_61.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_61.scrollableRegion.height > this.var_61.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_61.width += 17;
            }
         }
         else if(_loc4_)
         {

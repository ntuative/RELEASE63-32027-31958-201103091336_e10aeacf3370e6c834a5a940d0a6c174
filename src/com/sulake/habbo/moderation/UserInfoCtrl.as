package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_977:int = 60;
      
      private static const const_974:int = 3600;
      
      private static const const_975:int = 86400;
      
      private static const const_976:int = 31536000;
      ...
      {
         if(param1 < 2 * const_977)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_974)
         {
            return Math.round(param1 / const_977) + " mins ago";
         }
         if(param1 < 2 * const_975)
         {
            return Math.round(param1 / const_974) + " hours ago";
         }
         if(param1 < 2 * const_976)
         {
            return Math.round(param1 / const_975) + " days ago";
         }
         return Math.round(param1 / const_976) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1175,this._data.userId),this._callerFrame,this.var_1209,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1209,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1448),this._callerFrame,this.var_1209,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1448),this._callerFrame,this.var_1209,false,true);
      }

package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1507:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1525:int = 9;
       
      
      private var var_1943:Dictionary;
      
      public function WindowTracker()
      {
         this.var_1943 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_1943[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1943[param1] = _loc2_;
         }
         return _loc2_;
      }
   }

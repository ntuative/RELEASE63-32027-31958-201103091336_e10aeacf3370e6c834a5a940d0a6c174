package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1887:GroupDetailsView;
      ...
      private var var_627:ProductDataParser;
      ...
      private var var_1890:UserTagManager;
      
      private var var_1470:BadgeImageManager;
      
      private var var_1184:HabboGroupInfoManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2822 = [];
         this.var_1890 = new UserTagManager(events);
         this.var_1184 = new HabboGroupInfoManager(this,events);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_314)
         {
            this.var_314.removeEventListener(FurnitureDataParser.const_119,this.onFurnitureReady);
            this.var_314.dispose();
            this.var_314 = null;
         }
         if(this.var_627)
         {
            this.var_627.removeEventListener(ProductDataParser.const_119,this.onProductsReady);
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1890.communication = this._communication;
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_314)
         {
            ...
            this.var_314 = new FurnitureDataParser(this.var_511,this._wallItems,this.var_510,this._localization);
            this.var_314.addEventListener(FurnitureDataParser.const_119,this.onFurnitureReady);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2056 = _loc2_.clubLevel;
         this.var_1889 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2550 = _loc3_.respectTotal;
         this.var_1185 = _loc3_.respectLeft;
         this.var_774 = _loc3_.petRespectLeft;
         this._figure = _loc3_.figure;
         this.var_994 = _loc3_.sex;
         this.var_1616 = _loc3_.realName;
         this.var_2667 = _loc3_.identityId;
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            this.var_994 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this._figure,this.var_994));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2666 = _loc2_.isOpen;
         this.var_2668 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1889 >= SecurityLevelEnum.const_1048;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1890.getTags(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1887 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1184.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1887.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1184.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1184.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1470.getBadgeImage(param1,BadgeImageManager.const_1077);
      }
      ...
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_774 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_774 = this.var_774 - 1;
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_510.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(this.var_1186.indexOf(param1) == -1)
         {
         ...
         if(this.var_627 == null)
         {
            ...
            this.var_627 = new ProductDataParser(_loc2_,this.var_1210);
            this.var_627.addEventListener(ProductDataParser.const_119,this.onProductsReady);
         }
         return false;
      }
      ...
      private function onProductsReady(param1:Event) : void
      {
         ...
         this.var_627.removeEventListener(ProductDataParser.const_119,this.onProductsReady);
         this.var_1888 = true;
         for each(_loc2_ in this.var_1186)
         {
